...
description: Complete reference for all SDK methods available through window.next
sidebar:
  order: 1
---
...
<Aside type="caution">
**Important**: Most cart methods require an options object with `packageId` property, not a direct package ID.
</Aside>
...
- [Events](/docs/javascript-api/events/) - Event system reference
- [Callbacks](/docs/javascript-api/callbacks/) - Legacy callback patterns
- [Cart Methods](/docs/javascript-api/cart-methods/) - Detailed cart operations
