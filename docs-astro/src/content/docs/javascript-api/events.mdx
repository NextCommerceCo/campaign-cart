---
title: Events
description: Complete reference for all SDK events and event handling
sidebar:
  order: 2
---
...
<Aside type="tip">
The SDK has two types of events: DOM events for SDK lifecycle and internal events for cart/checkout operations. Use `document.addEventListener` for DOM events and `next.on()` for internal events.
</Aside>
...
- [JavaScript API Methods](/docs/javascript-api/) - Using SDK methods
- [Callbacks](/docs/javascript-api/callbacks/) - Legacy callback patterns
- [Analytics](/docs/javascript-api/analytics/) - Tracking and analytics
- [Data Attributes](/docs/data-attributes/) - HTML-based event triggers