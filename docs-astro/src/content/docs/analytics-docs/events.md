...
Complete reference of all analytics events with schemas, examples, and when they fire.
...
- [Custom Events](./custom-events.md) - Creating custom events
- [Providers](./providers.md) - Provider integration guides
