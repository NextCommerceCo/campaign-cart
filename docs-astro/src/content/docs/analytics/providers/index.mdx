...
description: Configure multiple analytics providers to send events simultaneously to GTM, Facebook Pixel, RudderStack, and custom platforms.
---
...
- **[Google Tag Manager](/analytics/providers/google-tag-manager/)** - Container setup and variable configuration
- **[Facebook Pixel](/analytics/providers/facebook-pixel/)** - Conversion tracking and audience building
- **[RudderStack](/analytics/providers/rudderstack/)** - Data warehouse and CDP integration
- **[Custom Webhook](/analytics/providers/custom-webhook/)** - Third-party API integration

### Alternative Integrations

- **[Direct GA4 (No GTM)](/analytics/providers/direct-ga4/)** - Send events directly to Google Analytics 4 without GTM
- **[Event Transformers](/analytics/advanced/event-transformers/)** - Build custom transformers for any platform (TikTok, Snapchat, Pinterest, etc.)
