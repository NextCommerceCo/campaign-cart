...
<Aside type="tip">
This is a specific implementation of the general [Event Transformers](/analytics/advanced/event-transformers/) pattern. You can use the same approach for TikTok, Snapchat, Pinterest, or any other platform.
</Aside>
...
In these cases, use Google Tag Manager instead. See [Google Tag Manager Setup](/analytics/providers/google-tag-manager/).

## Build Your Own Transformer

Want to adapt this pattern for other platforms (TikTok, Snapchat, Pinterest)?

See **[Event Transformers](/analytics/advanced/event-transformers/)** for:
...
- **[Event Transformers](/analytics/advanced/event-transformers/)** - General pattern for any platform
- [Google Tag Manager Setup](/analytics/providers/google-tag-manager/) - Alternative using GTM
- [Analytics Overview](/analytics/) - Main analytics documentation
- [Event Reference](/analytics/events/) - All available events
- [Configuration](/analytics/configuration/) - SDK configuration options
