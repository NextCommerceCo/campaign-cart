...
<TabItem label="Advanced API (NextAnalytics)">
...
See [Custom Events Guide](/analytics/custom-events/) for advanced patterns and EventBuilder usage.
...
- [Configuration & Modes](/analytics/configuration/) - Configure tracking modes and providers
- [Event Reference](/analytics/events/) - Complete event schemas and examples
- [Custom Events](/analytics/custom-events/) - Advanced tracking patterns with EventBuilder
