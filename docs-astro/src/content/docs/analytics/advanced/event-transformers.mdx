...
- **[GA4 Transformer](../../../utilities/NextDataLayer_GA4.js)** - Google Analytics 4
...
- [Custom Events](/analytics/custom-events/) - Creating custom events
- [Providers](/analytics/providers/) - Built-in provider integrations
