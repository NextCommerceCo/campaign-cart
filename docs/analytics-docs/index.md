...
1. **Configure providers** - Set up GTM, Facebook Pixel, or other platforms
   ...
   See [Providers Overview](./providers.md)

2. **Learn tracking methods** - Understand the tracking API

   See [Tracking API Reference](./tracking-api.md)

3. **Review events** - See all standard e-commerce events

   See [Event Reference](./events.md)

4. **Advanced tracking** - Create custom events and use transform functions

   See [Custom Events](./custom-events.md)

## Documentation Structure

- **[Configuration & Modes](./configuration.md)** - Detailed configuration options
- **[Tracking API Reference](./tracking-api.md)** - Complete API documentation
- **[Providers](./providers.md)** - Provider-specific setup guides
- **[Event Reference](./events.md)** - Complete event schemas and examples
- **[Custom Events](./custom-events.md)** - Advanced tracking patterns
- **[Debugging](./debugging.md)** - Troubleshooting and testing
- **[Best Practices](./best-practices.md)** - Implementation patterns and tips
