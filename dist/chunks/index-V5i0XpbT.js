import { u as useCartStore, b as useAttributionStore, a as useCheckoutStore } from "./analytics-DZhE6oeR.js";
import { L as Logger, E as EventBus, u as useCampaignStore, a as configStore, d as useProfileStore, e as useParameterStore, c as createLogger, b as CART_STORAGE_KEY, C as CountryService, g as LogLevel } from "./utils-B70_3MK6.js";
import { u as useOrderStore, t as testModeManager } from "./debug-DqJu1Tby.js";
import { ApiClient } from "./api-B5QexHPD.js";
class NextCommerce {
  constructor() {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-DZhE6oeR.js").then((n) => n.i);
  ...
  async trackViewItem(packageId) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-DZhE6oeR.js").then((n) => n.i);
        const { useCampaignStore: useCampaignStore2 } = await import("./utils-B70_3MK6.js").then((n) => n.B);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./analytics-DZhE6oeR.js").then((n) => n.i);
        nextAnalytics.track(
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-3rffI8GR.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-8EpfUS_x.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-B9KqLt8y.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-BHxauD-h.js");
        ...
        case "package-toggle":
          const { PackageToggleEnhancer } = await import("./PackageToggleEnhancer-VIuNBsxu.js");
          return new PackageToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./AddToCartEnhancer-gDp_PxYP.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-BTa-b4Wn.js");
        ...
        case "package-selector":
          const { PackageSelectorEnhancer } = await import("./PackageSelectorEnhancer-CNZIJRoM.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-BtO3UK3N.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-mGneOkED.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-N6Te9utQ.js");
        ...
        case "checkout-review":
          ...
          const { CheckoutReviewEnhancer } = await import("./CheckoutReviewEnhancer-CQnHvP7j.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-CKg6aEWU.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-DOcDRwxk.js");
          return new CartItemListEnhancer(element);
        case "cart-summary":
          const { CartSummaryEnhancer } = await import("./CartSummaryEnhancer-UaqYzX6g.js");
          return new CartSummaryEnhancer(element);
        case "bundle-selector":
          const { BundleSelectorEnhancer } = await import("./BundleSelectorEnhancer-B-NZUF8s.js");
          return new BundleSelectorEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-DrsF19Z_.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./QuantityControlEnhancer-CjkzvV-F.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./RemoveItemEnhancer-HVTKplQn.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-dLouuPKa.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-BE8KrMAq.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-phxvJR4N.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-BF0DPQUD.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-1FUEmQvG.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-D8qADTnX.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async captureUrlParameters(urlParams) {
    try {
      const { useParameterStore: useParameterStore2 } = await import("./utils-B70_3MK6.js").then((n) => n.I);
  ...
  static async processProfileParameter() {
    ...
    if (configStore$1.profiles && Object.keys(configStore$1.profiles).length > 0) {
      const { useProfileStore: useProfileStore22 } = await import("./utils-B70_3MK6.js").then((n) => n.G);
    ...
    const { useProfileStore: useProfileStore2 } = await import("./utils-B70_3MK6.js").then((n) => n.G);
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-B70_3MK6.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-B70_3MK6.js").then((n) => n.N).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./debug-DqJu1Tby.js").then((n) => n.D);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./debug-DqJu1Tby.js").then((n) => n.D).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-B9KqLt8y.js");
        import("./PackageToggleEnhancer-VIuNBsxu.js");
        import("./PackageSelectorEnhancer-CNZIJRoM.js");
        import("./ProductDisplayEnhancer-gZFW6wKI.js");
        import("./SelectionDisplayEnhancer-BHxauD-h.js");
        import("./TimerEnhancer-BtO3UK3N.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-N6Te9utQ.js");
        import("./ExpressCheckoutContainerEnhancer-CKg6aEWU.js");
        import("./OrderDisplayEnhancer-6rGy1Aus.js");
        import("./UpsellEnhancer-dLouuPKa.js");
        import("./utils-B70_3MK6.js").then((n) => n.M);
        import("./CartItemListEnhancer-DOcDRwxk.js");
        import("./QuantityControlEnhancer-CjkzvV-F.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-phxvJR4N.js");
        import("./CouponEnhancer-BE8KrMAq.js");
        import("./SimpleExitIntentEnhancer-3rffI8GR.js");
      ...
      setTimeout(() => {
        import("./CartDisplayEnhancer-B9KqLt8y.js");
        import("./ProductDisplayEnhancer-gZFW6wKI.js");
        import("./utils-B70_3MK6.js").then((n) => n.O);
      }, 1e3);
    }
  });
}
