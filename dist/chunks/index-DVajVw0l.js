import { a as useCartStore, u as useCampaignStore, d as useAttributionStore, b as useCheckoutStore, c as configStore } from "./analytics-38ZOc1ko.js";
import { u as useOrderStore, t as testModeManager } from "./debug-DTDoDSMd.js";
import { L as Logger, E as EventBus, u as useParameterStore, c as createLogger, b as CountryService, C as CART_STORAGE_KEY, d as LogLevel } from "./utils-C50dL0y-.js";
import { ApiClient } from "./api-13wriVbg.js";
class NextCommerce {
  constructor() {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-38ZOc1ko.js").then((n) => n.j);
  ...
  async trackViewItem(packageId) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-38ZOc1ko.js").then((n) => n.j);
        const { useCampaignStore: useCampaignStore2 } = await import("./analytics-38ZOc1ko.js").then((n) => n.f);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./analytics-38ZOc1ko.js").then((n) => n.j);
        nextAnalytics.track(
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-Bf0Zx9tf.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-B2GAnpIU.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart" || parsed.object === "cart-summary") {
            ...
            const { CartDisplayEnhancer } = await import("./index-VUY9PlN0.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-DZ9hTGky.js");
            ...
            const { PackageSelectorDisplayEnhancer } = await import("./index-Vb9puUDI.js");
            ...
            const { PackageToggleDisplayEnhancer } = await import("./index-I3LL23gv.js");
        ...
        case "package-toggle":
          const { PackageToggleEnhancer } = await import("./index-I3LL23gv.js");
          return new PackageToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./index-DiR6f9XF.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./index-Cu8UQ6XJ.js");
        ...
        case "package-selector":
          const { PackageSelectorEnhancer } = await import("./index-Vb9puUDI.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-DJVXMbAZ.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-B3xHHKBM.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-ulcyGjXE.js");
        ...
        case "checkout-review":
          ...
          const { CheckoutReviewEnhancer } = await import("./CheckoutReviewEnhancer-Btuw1WAO.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-RTWJE9kQ.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./index-CBpsldqc.js");
          return new CartItemListEnhancer(element);
        case "cart-summary":
          const { CartSummaryEnhancer } = await import("./index-VUY9PlN0.js");
          return new CartSummaryEnhancer(element);
        case "bundle-selector":
          const { BundleSelectorEnhancer } = await import("./index-BO6nBueg.js");
          return new BundleSelectorEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-DHe-9tft.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./index-DU0sWpiV.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./index-COnKBF-P.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./index-Bd1LR2SC.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-DLiki_13.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-CZC0hF1M.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-BLkySOTe.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-BB384ca8.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-DhZxehKs.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async captureUrlParameters(urlParams) {
    try {
      const { useParameterStore: useParameterStore2 } = await import("./utils-C50dL0y-.js").then((n) => n.y);
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-C50dL0y-.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-C50dL0y-.js").then((n) => n.G).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./debug-DTDoDSMd.js").then((n) => n.D);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./debug-DTDoDSMd.js").then((n) => n.D).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./index-VUY9PlN0.js");
        import("./index-I3LL23gv.js");
        import("./index-Vb9puUDI.js");
        import("./ProductDisplayEnhancer-DWOes6EO.js");
        import("./SelectionDisplayEnhancer-DZ9hTGky.js");
        import("./TimerEnhancer-DJVXMbAZ.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-ulcyGjXE.js");
        import("./ExpressCheckoutContainerEnhancer-RTWJE9kQ.js");
        import("./OrderDisplayEnhancer-xwf2rDZN.js");
        import("./index-Bd1LR2SC.js");
        import("./utils-C50dL0y-.js").then((n) => n.A);
        import("./index-CBpsldqc.js");
        import("./index-DU0sWpiV.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-CZC0hF1M.js");
        import("./CouponEnhancer-DLiki_13.js");
        import("./SimpleExitIntentEnhancer-Bf0Zx9tf.js");
      }, { timeout: 5e3 });
    } else {
      setTimeout(() => {
        import("./index-VUY9PlN0.js");
        import("./ProductDisplayEnhancer-DWOes6EO.js");
        import("./utils-C50dL0y-.js").then((n) => n.H);
      }, 1e3);
    }
  });
}
