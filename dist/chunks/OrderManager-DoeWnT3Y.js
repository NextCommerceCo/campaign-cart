import { n as nextAnalytics, E as EcommerceEvents, u as useCampaignStore, c as configStore, e as useAttributionStore, a as useCartStore, b as useCheckoutStore } from "./analytics-C593VfhV.js";
import { t as getFailureUrl, v as getSuccessUrl, w as handleOrderRedirect } from "./utils-CJHo6zrd.js";
...
class OrderManager {
  ...
  async createExpressOrder(cartItems, paymentMethod) {
    ...
    try {
      ...
      const { useCheckoutStore: useCheckoutStore2 } = await import("./analytics-C593VfhV.js").then((n) => n.h);
