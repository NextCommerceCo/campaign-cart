import { n as nextAnalytics, E as EcommerceEvents } from "./analytics-Bh09LY-K.js";
import { s as getFailureUrl, t as getSuccessUrl, u as handleOrderRedirect } from "./utils-BfE7Qi7b.js";
import { a as useCampaignStore, b as configStore, d as useAttributionStore, e as useCartStore, u as useCheckoutStore } from "./stores-ow46YhGU.js";
...
class OrderManager {
  ...
  async createExpressOrder(cartItems, paymentMethod) {
    ...
    try {
      ...
      const { useCheckoutStore: useCheckoutStore2 } = await import("./stores-ow46YhGU.js").then((n) => n.k);
