import { c as createLogger, L as Logger, b as CountryService, E as EventBus, f as formatCurrency } from "./utils-CJHo6zrd.js";
import { c as configStore, u as useCampaignStore, a as useCartStore, b as useCheckoutStore } from "./analytics-C593VfhV.js";
...
class LocaleSelector {
  ...
  async handleLocaleChange(newLocale, isReset = false) {
    ...
    try {
      ...
      const { CurrencyFormatter } = await import("./utils-CJHo6zrd.js").then((n) => n.H);
      CurrencyFormatter.clearCache();
      const { useCartStore: useCartStore2 } = await import("./analytics-C593VfhV.js").then((n) => n.i);
