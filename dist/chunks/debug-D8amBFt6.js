import { L as Logger, a as configStore, b as useCampaignStore, e as useCartStore, E as EventBus, f as useOrderStore, d as useCheckoutStore } from "./stores-CgBkvYdT.js";
import { C as CountryService, f as formatCurrency } from "./utils-D0Guuvf0.js";
...
import { r as reconcileValue } from "./analytics-Buzgs8AR.js";
...
class LocaleSelector {
  ...
  async handleLocaleChange(newLocale, isReset = false) {
    ...
    try {
      ...
      const { CurrencyFormatter } = await import("./utils-D0Guuvf0.js").then((n) => n.x);
      CurrencyFormatter.clearCache();
      const { useCartStore: useCartStore2 } = await import("./stores-CgBkvYdT.js").then((n) => n.i);
