import { a as useCartStore, u as useCampaignStore, e as useAttributionStore, b as useCheckoutStore, c as configStore, d as useProfileStore } from "./analytics-CyPVhTFQ.js";
import { u as useOrderStore, t as testModeManager } from "./debug-BuH0vCZk.js";
import { L as Logger, E as EventBus, u as useParameterStore, c as createLogger, b as CountryService, C as CART_STORAGE_KEY, d as LogLevel } from "./utils-DGJWv0Vp.js";
import { ApiClient } from "./api-CR3WFTO1.js";
class NextCommerce {
  constructor() {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-CyPVhTFQ.js").then((n) => n.k);
  ...
  async trackViewItem(packageId) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-CyPVhTFQ.js").then((n) => n.k);
        const { useCampaignStore: useCampaignStore2 } = await import("./analytics-CyPVhTFQ.js").then((n) => n.g);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./analytics-CyPVhTFQ.js").then((n) => n.k);
        nextAnalytics.track(
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-CBz6GbUF.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-BAmXbHjl.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart" || parsed.object === "cart-summary") {
            ...
            const { CartDisplayEnhancer } = await import("./index-PnPFT1lP.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-DGe8APlD.js");
            ...
            const { PackageSelectorDisplayEnhancer } = await import("./index-CSjOwjyv.js");
            ...
            const { PackageToggleDisplayEnhancer } = await import("./index-9StrMKX7.js");
        ...
        case "package-toggle":
          const { PackageToggleEnhancer } = await import("./index-9StrMKX7.js");
          return new PackageToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./index-s9FX10tC.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./index-D_Z7b-dx.js");
        ...
        case "package-selector":
          const { PackageSelectorEnhancer } = await import("./index-CSjOwjyv.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-BaE6pJRT.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-DfoTsXpJ.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-oxS6a_fd.js");
        ...
        case "checkout-review":
          ...
          const { CheckoutReviewEnhancer } = await import("./CheckoutReviewEnhancer-DWAOpHvK.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-oPsAA04V.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./index-BuZsvqXj.js");
          return new CartItemListEnhancer(element);
        case "cart-summary":
          const { CartSummaryEnhancer } = await import("./index-PnPFT1lP.js");
          return new CartSummaryEnhancer(element);
        case "bundle-selector":
          const { BundleSelectorEnhancer } = await import("./index-C8l8DtQn.js");
          return new BundleSelectorEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-FY9zFfZF.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./index-D2z5VR5L.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-DJxeUzVA.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-CchgEYsI.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-C92c3yAX.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-Dt_JXR3j.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-CiuxNZbj.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async captureUrlParameters(urlParams) {
    try {
      const { useParameterStore: useParameterStore2 } = await import("./utils-DGJWv0Vp.js").then((n) => n.A);
  ...
  static async processProfileParameter() {
    ...
    if (configStore$1.profiles && Object.keys(configStore$1.profiles).length > 0) {
      const { useProfileStore: useProfileStore22 } = await import("./analytics-CyPVhTFQ.js").then((n) => n.p);
    ...
    const { useProfileStore: useProfileStore2 } = await import("./analytics-CyPVhTFQ.js").then((n) => n.p);
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-DGJWv0Vp.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-DGJWv0Vp.js").then((n) => n.I).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./debug-BuH0vCZk.js").then((n) => n.D);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./debug-BuH0vCZk.js").then((n) => n.D).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./index-PnPFT1lP.js");
        import("./index-9StrMKX7.js");
        import("./index-CSjOwjyv.js");
        import("./ProductDisplayEnhancer-DPQkd3so.js");
        import("./SelectionDisplayEnhancer-DGe8APlD.js");
        import("./TimerEnhancer-BaE6pJRT.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-oxS6a_fd.js");
        import("./ExpressCheckoutContainerEnhancer-oPsAA04V.js");
        import("./OrderDisplayEnhancer-n-Hp3Fkn.js");
        import("./index-D2z5VR5L.js");
        import("./utils-DGJWv0Vp.js").then((n) => n.G);
        import("./index-BuZsvqXj.js");
        import("./index-DvD167BG.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-CchgEYsI.js");
        import("./CouponEnhancer-DJxeUzVA.js");
        import("./SimpleExitIntentEnhancer-CBz6GbUF.js");
      ...
      setTimeout(() => {
        import("./index-PnPFT1lP.js");
        import("./ProductDisplayEnhancer-DPQkd3so.js");
        import("./utils-DGJWv0Vp.js").then((n) => n.J);
      }, 1e3);
    }
  });
}
