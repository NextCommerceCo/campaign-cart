import { a as useCartStore, u as useCampaignStore, d as useAttributionStore, b as useCheckoutStore, c as configStore } from "./analytics-Ci0jTs8y.js";
import { u as useOrderStore, t as testModeManager } from "./debug-CDfDA2hB.js";
import { L as Logger, E as EventBus, u as useParameterStore, c as createLogger, b as CountryService, C as CART_STORAGE_KEY, d as LogLevel } from "./utils-DTwlwnMm.js";
import { ApiClient } from "./api-CCnFIjq2.js";
class NextCommerce {
  constructor() {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-Ci0jTs8y.js").then((n) => n.j);
  ...
  async trackViewItem(packageId) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-Ci0jTs8y.js").then((n) => n.j);
        const { useCampaignStore: useCampaignStore2 } = await import("./analytics-Ci0jTs8y.js").then((n) => n.f);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./analytics-Ci0jTs8y.js").then((n) => n.j);
        nextAnalytics.track(
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-D_MwCbj9.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-ClvelWR4.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart" || parsed.object === "cart-summary") {
            ...
            const { CartDisplayEnhancer } = await import("./index-DOoRX8XK.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-vVArzT7u.js");
            ...
            const { PackageSelectorDisplayEnhancer } = await import("./index-Bgm6SlND.js");
            ...
            const { PackageToggleDisplayEnhancer } = await import("./index-C-2i4AwN.js");
        ...
        case "package-toggle":
          const { PackageToggleEnhancer } = await import("./index-C-2i4AwN.js");
          return new PackageToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./index-CPrlGrbo.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./index-DWir-b1c.js");
        ...
        case "package-selector":
          const { PackageSelectorEnhancer } = await import("./index-Bgm6SlND.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-DjoHS306.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-C4TQwT_Z.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-CK2URphi.js");
        ...
        case "checkout-review":
          ...
          const { CheckoutReviewEnhancer } = await import("./CheckoutReviewEnhancer-D7XCM91w.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-AzOHyJ_o.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./index-CzXVLpP3.js");
          return new CartItemListEnhancer(element);
        case "cart-summary":
          const { CartSummaryEnhancer } = await import("./index-DOoRX8XK.js");
          return new CartSummaryEnhancer(element);
        case "bundle-selector":
          const { BundleSelectorEnhancer } = await import("./index-DkbfQqOc.js");
          return new BundleSelectorEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-DayfBMkn.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./index-v_lD_NCa.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./index-C7YTq892.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./index-DBDLuMPa.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-De7OVs0d.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-DgG1p406.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-CAYDlkUG.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-_8T1fgqW.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-DwclO84P.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async captureUrlParameters(urlParams) {
    try {
      const { useParameterStore: useParameterStore2 } = await import("./utils-DTwlwnMm.js").then((n) => n.y);
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-DTwlwnMm.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-DTwlwnMm.js").then((n) => n.G).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./debug-CDfDA2hB.js").then((n) => n.D);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./debug-CDfDA2hB.js").then((n) => n.D).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./index-DOoRX8XK.js");
        import("./index-C-2i4AwN.js");
        import("./index-Bgm6SlND.js");
        import("./ProductDisplayEnhancer-DyOPR36H.js");
        import("./SelectionDisplayEnhancer-vVArzT7u.js");
        import("./TimerEnhancer-DjoHS306.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-CK2URphi.js");
        import("./ExpressCheckoutContainerEnhancer-AzOHyJ_o.js");
        import("./OrderDisplayEnhancer-CEA1uNNv.js");
        import("./index-DBDLuMPa.js");
        import("./utils-DTwlwnMm.js").then((n) => n.A);
        import("./index-CzXVLpP3.js");
        import("./index-v_lD_NCa.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-DgG1p406.js");
        import("./CouponEnhancer-De7OVs0d.js");
        import("./SimpleExitIntentEnhancer-D_MwCbj9.js");
      }, { timeout: 5e3 });
    } else {
      setTimeout(() => {
        import("./index-DOoRX8XK.js");
        import("./ProductDisplayEnhancer-DyOPR36H.js");
        import("./utils-DTwlwnMm.js").then((n) => n.H);
      }, 1e3);
    }
  });
}
