import { c as createLogger, L as Logger, d as CountryService, E as EventBus } from "./utils-B9O2c6Dq.js";
import { c as configStore, u as useCampaignStore, a as useCartStore } from "./analytics-oP9thflZ.js";
import { c as create, p as persist, d as devtools } from "./vendor-SXWB56lk.js";
...
class LocaleSelector {
  ...
  async handleLocaleChange(newLocale, isReset = false) {
    ...
    try {
      ...
      const { CurrencyFormatter } = await import("./utils-B9O2c6Dq.js").then((n) => n.y);
      CurrencyFormatter.clearCache();
      const { useCartStore: useCartStore2 } = await import("./analytics-oP9thflZ.js").then((n) => n.f);
