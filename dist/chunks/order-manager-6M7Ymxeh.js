import { n as nextAnalytics, b as EcommerceEvents } from "./analytics-rw-aPuCY.js";
import { o as getFailureUrl, q as getSuccessUrl, s as handleOrderRedirect } from "./utils-w-A9JGvN.js";
import { a as useCampaignStore, c as configStore, b as useAttributionStore, d as useCartStore, u as useCheckoutStore } from "./state-Cak3W8JX.js";
...
class OrderManager {
  ...
  async createExpressOrder(cartItems, paymentMethod) {
    ...
    try {
      ...
      const { useCheckoutStore: useCheckoutStore2 } = await import("./state-Cak3W8JX.js").then((n) => n.k);
