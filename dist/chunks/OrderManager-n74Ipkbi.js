import { n as nextAnalytics, E as EcommerceEvents, u as useCampaignStore, c as configStore, e as useAttributionStore, a as useCartStore, b as useCheckoutStore } from "./analytics-CyPVhTFQ.js";
import { t as getFailureUrl, v as getSuccessUrl, w as handleOrderRedirect } from "./utils-DGJWv0Vp.js";
...
class OrderManager {
  ...
  async createExpressOrder(cartItems, paymentMethod) {
    ...
    try {
      ...
      const { useCheckoutStore: useCheckoutStore2 } = await import("./analytics-CyPVhTFQ.js").then((n) => n.h);
