import { n as nextAnalytics, E as EcommerceEvents, u as useCampaignStore, c as configStore, d as useAttributionStore, a as useCartStore, b as useCheckoutStore } from "./analytics-LH4fYFUJ.js";
import { r as getFailureUrl, t as getSuccessUrl, v as handleOrderRedirect } from "./utils-D3toSaf2.js";
...
class OrderManager {
  ...
  async createExpressOrder(cartItems, paymentMethod) {
    ...
    try {
      ...
      const { useCheckoutStore: useCheckoutStore2 } = await import("./analytics-LH4fYFUJ.js").then((n) => n.g);
