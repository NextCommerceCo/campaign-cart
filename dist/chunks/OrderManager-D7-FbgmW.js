import { n as nextAnalytics, E as EcommerceEvents, u as useCampaignStore, c as configStore, d as useAttributionStore, a as useCartStore, b as useCheckoutStore } from "./analytics-D4CaGccD.js";
import { r as getFailureUrl, t as getSuccessUrl, v as handleOrderRedirect } from "./utils-CMIpev9P.js";
...
class OrderManager {
  ...
  async createExpressOrder(cartItems, paymentMethod) {
    ...
    try {
      ...
      const { useCheckoutStore: useCheckoutStore2 } = await import("./analytics-D4CaGccD.js").then((n) => n.g);
