import { a as useCartStore, u as useCampaignStore, d as useAttributionStore, c as configStore, b as useProfileStore } from "./analytics-CehPPcOg.js";
import { u as useCheckoutStore, a as useOrderStore, t as testModeManager } from "./debug-9LkESLCH.js";
import { c as create, p as persist } from "./vendor-DmEBrpID.js";
import { c as createLogger, L as Logger, E as EventBus, d as CountryService, a as CART_STORAGE_KEY, e as LogLevel } from "./utils-CrhivV-X.js";
import { ApiClient } from "./api-B5iJlLHg.js";
...
class NextCommerce {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-CehPPcOg.js").then((n) => n.i);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./analytics-CehPPcOg.js").then((n) => n.i);
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-B0zPt-Xy.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-CkgKLow1.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-DyQm6cVf.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-B59M6AVm.js");
        ...
        case "toggle":
          const { CartToggleEnhancer } = await import("./CartToggleEnhancer-6SJofsZo.js");
          return new CartToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./AddToCartEnhancer-CE-IPE9y.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-6j5Kgh64.js");
        ...
        case "selector":
          const { PackageSelectorEnhancer } = await import("./PackageSelectorEnhancer-Wj4Jqp49.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-4IHyNon6.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-CnpS06uO.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-BN-uKOMK.js");
        ...
        case "checkout-review":
          ...
          const { CheckoutReviewEnhancer } = await import("./CheckoutReviewEnhancer-BEGeHLXX.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-Cr4Q3-G1.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-DsV0WYQu.js");
          return new CartItemListEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-DGI4WID9.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./QuantityControlEnhancer-_urobyiM.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./RemoveItemEnhancer-CHDkETiL.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-D_pioJin.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-CCIL4F9-.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-KlCHM9VP.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-eXGX4BCT.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-BSmc-N2u.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-CF211Qke.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async processProfileParameter() {
    ...
    if (configStore$1.profiles && Object.keys(configStore$1.profiles).length > 0) {
      const { useProfileStore: useProfileStore22 } = await import("./analytics-CehPPcOg.js").then((n) => n.p);
    ...
    const { useProfileStore: useProfileStore2 } = await import("./analytics-CehPPcOg.js").then((n) => n.p);
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-CrhivV-X.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-CrhivV-X.js").then((n) => n.z).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./debug-9LkESLCH.js").then((n) => n.D);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./debug-9LkESLCH.js").then((n) => n.D).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-DyQm6cVf.js");
        import("./CartToggleEnhancer-6SJofsZo.js");
        import("./PackageSelectorEnhancer-Wj4Jqp49.js");
        import("./ProductDisplayEnhancer-D9hae-dc.js");
        import("./SelectionDisplayEnhancer-B59M6AVm.js");
        import("./TimerEnhancer-4IHyNon6.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-BN-uKOMK.js");
        import("./ExpressCheckoutContainerEnhancer-Cr4Q3-G1.js");
        import("./OrderDisplayEnhancer-fM48sRr4.js");
        import("./UpsellEnhancer-D_pioJin.js");
        import("./utils-CrhivV-X.js").then((n) => n.A);
        import("./CartItemListEnhancer-DsV0WYQu.js");
        import("./QuantityControlEnhancer-_urobyiM.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-KlCHM9VP.js");
        import("./CouponEnhancer-CCIL4F9-.js");
        import("./SimpleExitIntentEnhancer-B0zPt-Xy.js");
      ...
      setTimeout(() => {
        import("./CartDisplayEnhancer-DyQm6cVf.js");
        import("./ProductDisplayEnhancer-D9hae-dc.js");
        import("./utils-CrhivV-X.js").then((n) => n.B);
      }, 1e3);
    }
  });
}
