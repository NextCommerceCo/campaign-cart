import { a as useCartStore, u as useCampaignStore, d as useAttributionStore, b as useCheckoutStore, c as configStore } from "./analytics-BSkaUArK.js";
import { u as useOrderStore, t as testModeManager } from "./debug-7xa8SR0J.js";
import { L as Logger, E as EventBus, u as useParameterStore, c as createLogger, b as CountryService, C as CART_STORAGE_KEY, d as LogLevel } from "./utils-eoibqppS.js";
...
class NextCommerce {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-BSkaUArK.js").then((n) => n.j);
  ...
  async trackViewItem(packageId) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-BSkaUArK.js").then((n) => n.j);
        const { useCampaignStore: useCampaignStore2 } = await import("./analytics-BSkaUArK.js").then((n) => n.f);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./analytics-BSkaUArK.js").then((n) => n.j);
        nextAnalytics.track(
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-Cg7IKVYA.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-BAaBYz3G.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart" || parsed.object === "cart-summary") {
            ...
            const { CartDisplayEnhancer } = await import("./index-BvwjFjA2.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-CsuZFf47.js");
            ...
            const { PackageSelectorDisplayEnhancer } = await import("./index-DBz6zi3Y.js");
            ...
            const { PackageToggleDisplayEnhancer } = await import("./index-DsBdtHi_.js");
        ...
        case "package-toggle":
          const { PackageToggleEnhancer } = await import("./index-DsBdtHi_.js");
          return new PackageToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./index-gooP9H-4.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./index-CK2H6leY.js");
        ...
        case "package-selector":
          const { PackageSelectorEnhancer } = await import("./index-DBz6zi3Y.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-ChETroQt.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-BUXiTLvZ.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-B-A4vTfg.js");
        ...
        case "checkout-review":
          ...
          const { CheckoutReviewEnhancer } = await import("./CheckoutReviewEnhancer-BeH6WvTP.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-CJkDAeLs.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./index-CW_S7o_w.js");
          return new CartItemListEnhancer(element);
        case "cart-summary":
          const { CartSummaryEnhancer } = await import("./index-BvwjFjA2.js");
          return new CartSummaryEnhancer(element);
        case "bundle-selector":
          const { BundleSelectorEnhancer } = await import("./index-Cx1SzvFb.js");
          return new BundleSelectorEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-D6IHZrvw.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./index-CbS15Icn.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./index-BSHUsXGu.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./index-BsJ4VhZ8.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-BsJDRwW_.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-Btl8bheQ.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-DLP8knZv.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-DcUO6Xbm.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-Bk7HZ_0J.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async captureUrlParameters(urlParams) {
    try {
      const { useParameterStore: useParameterStore2 } = await import("./utils-eoibqppS.js").then((n) => n.H);
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-eoibqppS.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-eoibqppS.js").then((n) => n.M).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./debug-7xa8SR0J.js").then((n) => n.D);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./debug-7xa8SR0J.js").then((n) => n.D).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./index-BvwjFjA2.js");
        import("./index-DsBdtHi_.js");
        import("./index-DBz6zi3Y.js");
        import("./ProductDisplayEnhancer-CIUSb2lL.js");
        import("./SelectionDisplayEnhancer-CsuZFf47.js");
        import("./TimerEnhancer-ChETroQt.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-B-A4vTfg.js");
        import("./ExpressCheckoutContainerEnhancer-CJkDAeLs.js");
        import("./OrderDisplayEnhancer-BgGyUgBJ.js");
        import("./index-BsJ4VhZ8.js");
        import("./utils-eoibqppS.js").then((n) => n.J);
        import("./index-CW_S7o_w.js");
        import("./index-CbS15Icn.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-Btl8bheQ.js");
        import("./CouponEnhancer-BsJDRwW_.js");
        import("./SimpleExitIntentEnhancer-Cg7IKVYA.js");
      }, { timeout: 5e3 });
    } else {
      setTimeout(() => {
        import("./index-BvwjFjA2.js");
        import("./ProductDisplayEnhancer-CIUSb2lL.js");
        import("./utils-eoibqppS.js").then((n) => n.N);
      }, 1e3);
    }
  });
}
