import { a as useCartStore, u as useCampaignStore, d as useAttributionStore, b as useCheckoutStore, c as configStore } from "./analytics-BHJjHc1E.js";
import { u as useOrderStore, t as testModeManager } from "./debug-DA8wFB-u.js";
import { L as Logger, E as EventBus, u as useParameterStore, c as createLogger, b as CountryService, C as CART_STORAGE_KEY, d as LogLevel } from "./utils-R5pRn2AT.js";
...
class NextCommerce {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-BHJjHc1E.js").then((n) => n.j);
  ...
  async trackViewItem(packageId) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-BHJjHc1E.js").then((n) => n.j);
        const { useCampaignStore: useCampaignStore2 } = await import("./analytics-BHJjHc1E.js").then((n) => n.f);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./analytics-BHJjHc1E.js").then((n) => n.j);
        nextAnalytics.track(
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-TSILIahp.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-BB9CLXMA.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart" || parsed.object === "cart-summary") {
            ...
            const { CartDisplayEnhancer } = await import("./index-BMIK2WMC.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-DfqXgVwq.js");
            ...
            const { PackageSelectorDisplayEnhancer } = await import("./index-OJlv2SSz.js");
            ...
            const { PackageToggleDisplayEnhancer } = await import("./index-DH8snJx_.js");
        ...
        case "package-toggle":
          const { PackageToggleEnhancer } = await import("./index-DH8snJx_.js");
          return new PackageToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./index-BJPTycYg.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./index-C_2ESK-t.js");
        ...
        case "package-selector":
          const { PackageSelectorEnhancer } = await import("./index-OJlv2SSz.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-RC0RiAXS.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-BogjqVzS.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-PcW0TkDY.js");
        ...
        case "checkout-review":
          ...
          const { CheckoutReviewEnhancer } = await import("./CheckoutReviewEnhancer-0eizBU8Y.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-DL4M_GaA.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./index-CRDpSaWI.js");
          return new CartItemListEnhancer(element);
        case "cart-summary":
          const { CartSummaryEnhancer } = await import("./index-BMIK2WMC.js");
          return new CartSummaryEnhancer(element);
        case "bundle-selector":
          const { BundleSelectorEnhancer } = await import("./index-BnncIRL5.js");
          return new BundleSelectorEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-DYYPtviL.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./index-DDQDJ2xf.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./index-CjCropa8.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./index-BxQfb1_a.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-BGmT4tMB.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-0d4joq15.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-Dfp7ZiES.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-BSuuJywi.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-DkqifmJF.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async captureUrlParameters(urlParams) {
    try {
      const { useParameterStore: useParameterStore2 } = await import("./utils-R5pRn2AT.js").then((n) => n.B);
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-R5pRn2AT.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-R5pRn2AT.js").then((n) => n.J).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./debug-DA8wFB-u.js").then((n) => n.D);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./debug-DA8wFB-u.js").then((n) => n.D).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./index-BMIK2WMC.js");
        import("./index-DH8snJx_.js");
        import("./index-OJlv2SSz.js");
        import("./ProductDisplayEnhancer-UiFe3rOC.js");
        import("./SelectionDisplayEnhancer-DfqXgVwq.js");
        import("./TimerEnhancer-RC0RiAXS.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-PcW0TkDY.js");
        import("./ExpressCheckoutContainerEnhancer-DL4M_GaA.js");
        import("./OrderDisplayEnhancer-Bf5UjoFe.js");
        import("./index-BxQfb1_a.js");
        import("./utils-R5pRn2AT.js").then((n) => n.H);
        import("./index-CRDpSaWI.js");
        import("./index-DDQDJ2xf.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-0d4joq15.js");
        import("./CouponEnhancer-BGmT4tMB.js");
        import("./SimpleExitIntentEnhancer-TSILIahp.js");
      }, { timeout: 5e3 });
    } else {
      setTimeout(() => {
        import("./index-BMIK2WMC.js");
        import("./ProductDisplayEnhancer-UiFe3rOC.js");
        import("./utils-R5pRn2AT.js").then((n) => n.K);
      }, 1e3);
    }
  });
}
