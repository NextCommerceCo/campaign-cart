import { c as createLogger, L as Logger, a as configStore, u as useCampaignStore, C as CountryService, E as EventBus, f as formatCurrency } from "./utils-B70_3MK6.js";
...
class LocaleSelector {
  ...
  async handleLocaleChange(newLocale, isReset = false) {
    ...
    try {
      ...
      const { CurrencyFormatter } = await import("./utils-B70_3MK6.js").then((n) => n.J);
      CurrencyFormatter.clearCache();
      const { useCartStore: useCartStore2 } = await import("./analytics-DZhE6oeR.js").then((n) => n.d);
