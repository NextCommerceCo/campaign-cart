...
import { t as testModeManager } from "./debug-Mr2KqGdU.js";
...
class NextCommerce {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-C3b6QkOU.js").then((n) => n.i);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./analytics-C3b6QkOU.js").then((n) => n.i);
        nextAnalytics.track(
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart" || parsed.object === "cart-summary") {
            ...
            const { CartDisplayEnhancer } = await import("./index-BrQTQLU6.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-BsG9iyAf.js");
            ...
            const { PackageSelectorDisplayEnhancer } = await import("./index-vgZMAvdr.js");
            ...
            const { PackageToggleDisplayEnhancer } = await import("./index-DKLtnwP2.js");
        ...
        case "package-toggle":
          const { PackageToggleEnhancer } = await import("./index-DKLtnwP2.js");
        ...
        case "action":
          ...
          switch (action) {
            ...
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./index-g9a4Vdv3.js");
        ...
        case "package-selector":
          const { PackageSelectorEnhancer } = await import("./index-vgZMAvdr.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-Ca0LlfNg.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-GgiNMoCW.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-ByrrJXvJ.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./index-CW-29MAF.js");
          return new CartItemListEnhancer(element);
        case "cart-summary":
          const { CartSummaryEnhancer } = await import("./index-BrQTQLU6.js");
          return new CartSummaryEnhancer(element);
        case "bundle-selector":
          const { BundleSelectorEnhancer } = await import("./index-DJG2dL6P.js");
          return new BundleSelectorEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-BGz2RS2Z.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./debug-Mr2KqGdU.js").then((n) => n.D);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./debug-Mr2KqGdU.js").then((n) => n.D).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./index-BrQTQLU6.js");
        import("./index-DKLtnwP2.js");
        import("./index-vgZMAvdr.js");
        import("./ProductDisplayEnhancer-CXGzroze.js");
        import("./SelectionDisplayEnhancer-BsG9iyAf.js");
        import("./TimerEnhancer-a5htnWUy.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-GgiNMoCW.js");
        import("./ExpressCheckoutContainerEnhancer-ByrrJXvJ.js");
        import("./OrderDisplayEnhancer-BqxoS8aR.js");
        import("./index-DWLucDzg.js");
        import("./utils-BfE7Qi7b.js").then((n) => n.A);
        import("./index-CW-29MAF.js");
