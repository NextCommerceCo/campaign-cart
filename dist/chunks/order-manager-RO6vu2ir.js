import { n as nextAnalytics, b as EcommerceEvents } from "./analytics-DdhZlX6_.js";
import { f as getFailureUrl, h as getSuccessUrl, j as handleOrderRedirect } from "./utils-MHh-YCs2.js";
import { a as useCampaignStore, c as configStore, b as useAttributionStore, d as useCartStore, u as useCheckoutStore } from "./state-pM9xfsfc.js";
...
class OrderManager {
  ...
  async createExpressOrder(cartItems, paymentMethod) {
    ...
    try {
      ...
      const { useCheckoutStore: useCheckoutStore2 } = await import("./state-pM9xfsfc.js").then((n) => n.k);
