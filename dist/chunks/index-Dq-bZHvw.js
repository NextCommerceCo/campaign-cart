import { a as useCartStore, u as useCampaignStore, d as useAttributionStore, c as configStore, b as useProfileStore } from "./analytics-DY8BflmD.js";
import { u as useCheckoutStore, a as useOrderStore, t as testModeManager } from "./debug-Bot8wcvi.js";
import { L as Logger, E as EventBus, u as useParameterStore, c as createLogger, d as CountryService, a as CART_STORAGE_KEY, e as LogLevel } from "./utils-CzY7UvvD.js";
import { ApiClient } from "./api-CPPwAzK9.js";
class NextCommerce {
  constructor() {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-DY8BflmD.js").then((n) => n.i);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./analytics-DY8BflmD.js").then((n) => n.i);
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-DWqYFtt_.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-CsK7ImjT.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-dp1CjUmO.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-DMHOO2cI.js");
        ...
        case "toggle":
          const { CartToggleEnhancer } = await import("./CartToggleEnhancer-CrMi0k9g.js");
          return new CartToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./AddToCartEnhancer-CJPuab0E.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-CK6j0uOR.js");
        ...
        case "selector":
          const { PackageSelectorEnhancer } = await import("./PackageSelectorEnhancer-BYaHCPWU.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-CS2hnMlo.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-Pnab4rkJ.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-CKGMLoV4.js");
        ...
        case "checkout-review":
          ...
          const { CheckoutReviewEnhancer } = await import("./CheckoutReviewEnhancer-CkNahu3D.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-DtemMZAt.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-BSs1okjI.js");
          return new CartItemListEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-DqaLkZlK.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./QuantityControlEnhancer-s2pG3Kfn.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./RemoveItemEnhancer-vFYXSzXz.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-r0R_1C8R.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-B1tb1Hs3.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-BaMw5tgn.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-D7k3LdFL.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-BLVfWjxY.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-DS7zqUo4.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async captureUrlParameters(urlParams) {
    try {
      const { useParameterStore: useParameterStore2 } = await import("./utils-CzY7UvvD.js").then((n) => n.A);
  ...
  static async processProfileParameter() {
    ...
    if (configStore$1.profiles && Object.keys(configStore$1.profiles).length > 0) {
      const { useProfileStore: useProfileStore22 } = await import("./analytics-DY8BflmD.js").then((n) => n.p);
    ...
    const { useProfileStore: useProfileStore2 } = await import("./analytics-DY8BflmD.js").then((n) => n.p);
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-CzY7UvvD.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-CzY7UvvD.js").then((n) => n.G).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./debug-Bot8wcvi.js").then((n) => n.D);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./debug-Bot8wcvi.js").then((n) => n.D).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-dp1CjUmO.js");
        import("./CartToggleEnhancer-CrMi0k9g.js");
        import("./PackageSelectorEnhancer-BYaHCPWU.js");
        import("./ProductDisplayEnhancer-DjK_XM7Y.js");
        import("./SelectionDisplayEnhancer-DMHOO2cI.js");
        import("./TimerEnhancer-CS2hnMlo.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-CKGMLoV4.js");
        import("./ExpressCheckoutContainerEnhancer-DtemMZAt.js");
        import("./OrderDisplayEnhancer-BqZnxh7U.js");
        import("./UpsellEnhancer-r0R_1C8R.js");
        import("./utils-CzY7UvvD.js").then((n) => n.B);
        import("./CartItemListEnhancer-BSs1okjI.js");
        import("./QuantityControlEnhancer-s2pG3Kfn.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-BaMw5tgn.js");
        import("./CouponEnhancer-B1tb1Hs3.js");
        import("./SimpleExitIntentEnhancer-DWqYFtt_.js");
      ...
      setTimeout(() => {
        import("./CartDisplayEnhancer-dp1CjUmO.js");
        import("./ProductDisplayEnhancer-DjK_XM7Y.js");
        import("./utils-CzY7UvvD.js").then((n) => n.H);
      }, 1e3);
    }
  });
}
