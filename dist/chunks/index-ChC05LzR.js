import { a as useCartStore, u as useCampaignStore, d as useAttributionStore, c as configStore, b as useProfileStore } from "./analytics-DYqz9kiv.js";
import { u as useCheckoutStore, a as useOrderStore, t as testModeManager } from "./debug-BAsunnL8.js";
import { c as create, p as persist } from "./vendor-DmEBrpID.js";
import { c as createLogger, L as Logger, E as EventBus, d as CountryService, a as CART_STORAGE_KEY, e as LogLevel } from "./utils-6135MyCb.js";
import { ApiClient } from "./api-C3PXi1n2.js";
...
class NextCommerce {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-DYqz9kiv.js").then((n) => n.i);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./analytics-DYqz9kiv.js").then((n) => n.i);
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-NWZ8YL7A.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-CtNGiGJC.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-B5Be0hCL.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-CHEvfiPN.js");
        ...
        case "toggle":
          const { CartToggleEnhancer } = await import("./CartToggleEnhancer--XfkF4PG.js");
          return new CartToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./AddToCartEnhancer-D-b8Pmbg.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-yMRp35h7.js");
        ...
        case "selector":
          const { PackageSelectorEnhancer } = await import("./PackageSelectorEnhancer-BYgmEHyv.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-_HQW_J5f.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-D1DrnDXi.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-2XyKZA7n.js");
        ...
        case "checkout-review":
          ...
          const { CheckoutReviewEnhancer } = await import("./CheckoutReviewEnhancer-B4lFm4Ui.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-Bi8bCZqe.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-COTx5lu8.js");
          return new CartItemListEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-DlW4fv9l.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./QuantityControlEnhancer-BFAzJMuS.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./RemoveItemEnhancer-D5P5v6gv.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-CnidUouf.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-CIX5RaZv.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-Dpfub3Zp.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-OvA_921G.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-D70M0kH7.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-Dasb3mv4.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async processProfileParameter() {
    ...
    if (configStore$1.profiles && Object.keys(configStore$1.profiles).length > 0) {
      const { useProfileStore: useProfileStore22 } = await import("./analytics-DYqz9kiv.js").then((n) => n.p);
    ...
    const { useProfileStore: useProfileStore2 } = await import("./analytics-DYqz9kiv.js").then((n) => n.p);
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-6135MyCb.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-6135MyCb.js").then((n) => n.z).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./debug-BAsunnL8.js").then((n) => n.D);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./debug-BAsunnL8.js").then((n) => n.D).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-B5Be0hCL.js");
        import("./CartToggleEnhancer--XfkF4PG.js");
        import("./PackageSelectorEnhancer-BYgmEHyv.js");
        import("./ProductDisplayEnhancer-A119AcLf.js");
        import("./SelectionDisplayEnhancer-CHEvfiPN.js");
        import("./TimerEnhancer-_HQW_J5f.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-2XyKZA7n.js");
        import("./ExpressCheckoutContainerEnhancer-Bi8bCZqe.js");
        import("./OrderDisplayEnhancer-DwV8poE0.js");
        import("./UpsellEnhancer-CnidUouf.js");
        import("./utils-6135MyCb.js").then((n) => n.A);
        import("./CartItemListEnhancer-COTx5lu8.js");
        import("./QuantityControlEnhancer-BFAzJMuS.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-Dpfub3Zp.js");
        import("./CouponEnhancer-CIX5RaZv.js");
        import("./SimpleExitIntentEnhancer-NWZ8YL7A.js");
      ...
      setTimeout(() => {
        import("./CartDisplayEnhancer-B5Be0hCL.js");
        import("./ProductDisplayEnhancer-A119AcLf.js");
        import("./utils-6135MyCb.js").then((n) => n.B);
      }, 1e3);
    }
  });
}
