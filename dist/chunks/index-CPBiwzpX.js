import { u as useCartStore, b as useAttributionStore, a as useCheckoutStore } from "./analytics-BQliK5x8.js";
import { L as Logger, E as EventBus, u as useCampaignStore, a as configStore, e as useProfileStore, g as useParameterStore, c as createLogger, b as CART_STORAGE_KEY, C as CountryService, h as LogLevel } from "./utils-BuscMPQd.js";
import { u as useOrderStore, t as testModeManager } from "./debug-BIVYx0Wz.js";
import { ApiClient } from "./api-LxCaNviP.js";
class NextCommerce {
  constructor() {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-BQliK5x8.js").then((n) => n.i);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./analytics-BQliK5x8.js").then((n) => n.i);
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-CuVRfwQa.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-DSuEkwQ1.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-BqyO27rz.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-D-4crzp-.js");
        ...
        case "toggle":
          const { CartToggleEnhancer } = await import("./CartToggleEnhancer-VVgslgxn.js");
          return new CartToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./AddToCartEnhancer-CmeeIrJC.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-CFgwOuLF.js");
        ...
        case "selector":
          const { PackageSelectorEnhancer } = await import("./PackageSelectorEnhancer-Bw0Yc5_w.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-CrgblsGd.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-DohgM_r-.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-DGhdmoO7.js");
        ...
        case "checkout-review":
          ...
          const { CheckoutReviewEnhancer } = await import("./CheckoutReviewEnhancer-CiXNCaXq.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-BEZmyVUM.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-CGCNZtbT.js");
          return new CartItemListEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-B5jr86dL.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./QuantityControlEnhancer-xsGiBBvF.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./RemoveItemEnhancer-DiInRnV2.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-BQvYc2u7.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-Ckah8nGZ.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-Ci5Ep8uF.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-vCcdUaBw.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-Bt8Em1_D.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-CzuNCJEA.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async captureUrlParameters(urlParams) {
    try {
      const { useParameterStore: useParameterStore2 } = await import("./utils-BuscMPQd.js").then((n) => n.J);
  ...
  static async processProfileParameter() {
    ...
    if (configStore$1.profiles && Object.keys(configStore$1.profiles).length > 0) {
      const { useProfileStore: useProfileStore22 } = await import("./utils-BuscMPQd.js").then((n) => n.G);
    ...
    const { useProfileStore: useProfileStore2 } = await import("./utils-BuscMPQd.js").then((n) => n.G);
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-BuscMPQd.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-BuscMPQd.js").then((n) => n.M).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./debug-BIVYx0Wz.js").then((n) => n.D);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./debug-BIVYx0Wz.js").then((n) => n.D).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-BqyO27rz.js");
        import("./CartToggleEnhancer-VVgslgxn.js");
        import("./PackageSelectorEnhancer-Bw0Yc5_w.js");
        import("./ProductDisplayEnhancer-DKLvLbSs.js");
        import("./SelectionDisplayEnhancer-D-4crzp-.js");
        import("./TimerEnhancer-CrgblsGd.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-DGhdmoO7.js");
        import("./ExpressCheckoutContainerEnhancer-BEZmyVUM.js");
        import("./OrderDisplayEnhancer-SCj5kTOx.js");
        import("./UpsellEnhancer-BQvYc2u7.js");
        import("./utils-BuscMPQd.js").then((n) => n.K);
        import("./CartItemListEnhancer-CGCNZtbT.js");
        import("./QuantityControlEnhancer-xsGiBBvF.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-Ci5Ep8uF.js");
        import("./CouponEnhancer-Ckah8nGZ.js");
        import("./SimpleExitIntentEnhancer-CuVRfwQa.js");
      ...
      setTimeout(() => {
        import("./CartDisplayEnhancer-BqyO27rz.js");
        import("./ProductDisplayEnhancer-DKLvLbSs.js");
        import("./utils-BuscMPQd.js").then((n) => n.N);
      }, 1e3);
    }
  });
}
