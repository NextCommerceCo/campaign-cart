import { n as nextAnalytics, E as EcommerceEvents } from "./analytics-CDawIxrg.js";
import { q as getFailureUrl, s as getSuccessUrl, t as handleOrderRedirect } from "./utils-JP7GtpcB.js";
import { d as useCampaignStore, a as configStore, u as useAttributionStore, e as useCartStore, b as useCheckoutStore } from "./stores-DhBPTw5A.js";
...
class OrderManager {
  ...
  async createExpressOrder(cartItems, paymentMethod) {
    ...
    try {
      ...
      const { useCheckoutStore: useCheckoutStore2 } = await import("./stores-DhBPTw5A.js").then((n) => n.k);
      const vouchers = useCheckoutStore2.getState().vouchers;
