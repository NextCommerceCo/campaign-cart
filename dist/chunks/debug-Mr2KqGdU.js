import { L as Logger, b as configStore, a as useCampaignStore, e as useCartStore, E as EventBus, f as useOrderStore, u as useCheckoutStore } from "./stores-ow46YhGU.js";
import { C as CountryService, f as formatCurrency } from "./utils-BfE7Qi7b.js";
...
import { r as reconcileValue } from "./analytics-C3b6QkOU.js";
...
class LocaleSelector {
  ...
  async handleLocaleChange(newLocale, isReset = false) {
    ...
    try {
      ...
      const { CurrencyFormatter } = await import("./utils-BfE7Qi7b.js").then((n) => n.y);
      CurrencyFormatter.clearCache();
      const { useCartStore: useCartStore2 } = await import("./stores-ow46YhGU.js").then((n) => n.i);
