import { a as useCartStore, u as useCampaignStore, d as useAttributionStore, b as useCheckoutStore, c as configStore } from "./analytics-DDBbK97v.js";
import { u as useOrderStore, t as testModeManager } from "./debug-6wuGgI0A.js";
import { L as Logger, E as EventBus, u as useParameterStore, c as createLogger, a as CART_STORAGE_KEY, C as CountryService, d as LogLevel } from "./utils-D7bEf2-B.js";
import { ApiClient } from "./api-Bq4JBUws.js";
class NextCommerce {
  constructor() {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-DDBbK97v.js").then((n) => n.j);
  ...
  async trackViewItem(packageId) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-DDBbK97v.js").then((n) => n.j);
        const { useCampaignStore: useCampaignStore2 } = await import("./analytics-DDBbK97v.js").then((n) => n.f);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./analytics-DDBbK97v.js").then((n) => n.j);
        nextAnalytics.track(
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-DVO_2kSA.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-CPQAyh9C.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart" || parsed.object === "cart-summary") {
            ...
            const { CartDisplayEnhancer } = await import("./index-BWOlBhaK.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-LcGJ9TIk.js");
            ...
            const { PackageSelectorDisplayEnhancer } = await import("./index-D8aBsP-j.js");
            ...
            const { PackageToggleDisplayEnhancer } = await import("./index-CI469DaE.js");
        ...
        case "package-toggle":
          const { PackageToggleEnhancer } = await import("./index-CI469DaE.js");
          return new PackageToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./index-a66F--sR.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./index-BqmGAdra.js");
        ...
        case "package-selector":
          const { PackageSelectorEnhancer } = await import("./index-D8aBsP-j.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-DR37NzIn.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-BYNpnNZo.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-DHQ4bIFv.js");
        ...
        case "checkout-review":
          ...
          const { CheckoutReviewEnhancer } = await import("./CheckoutReviewEnhancer-BbIEIHpw.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-CY-KAWnl.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./index-DfGUZ4aY.js");
          return new CartItemListEnhancer(element);
        case "cart-summary":
          const { CartSummaryEnhancer } = await import("./index-BWOlBhaK.js");
          return new CartSummaryEnhancer(element);
        case "bundle-selector":
          const { BundleSelectorEnhancer } = await import("./index-BbGfZinb.js");
          return new BundleSelectorEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-DOsVPayZ.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./index-BIcy0L0_.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./index-CXYIkig4.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./index-BDFXLBX3.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-oj1wn3tl.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-BXE5bU30.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-Ck-ZhgET.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-DpP_5A4O.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-DcKPk9jI.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async captureUrlParameters(urlParams) {
    try {
      const { useParameterStore: useParameterStore2 } = await import("./utils-D7bEf2-B.js").then((n) => n.H);
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-D7bEf2-B.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-D7bEf2-B.js").then((n) => n.M).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./debug-6wuGgI0A.js").then((n) => n.D);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./debug-6wuGgI0A.js").then((n) => n.D).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./index-BWOlBhaK.js");
        import("./index-CI469DaE.js");
        import("./index-D8aBsP-j.js");
        import("./ProductDisplayEnhancer-erlXlu64.js");
        import("./SelectionDisplayEnhancer-LcGJ9TIk.js");
        import("./TimerEnhancer-DR37NzIn.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-DHQ4bIFv.js");
        import("./ExpressCheckoutContainerEnhancer-CY-KAWnl.js");
        import("./OrderDisplayEnhancer-V_UYSjLD.js");
        import("./index-BDFXLBX3.js");
        import("./utils-D7bEf2-B.js").then((n) => n.J);
        import("./index-DfGUZ4aY.js");
        import("./index-BIcy0L0_.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-BXE5bU30.js");
        import("./CouponEnhancer-oj1wn3tl.js");
        import("./SimpleExitIntentEnhancer-DVO_2kSA.js");
      }, { timeout: 5e3 });
    } else {
      setTimeout(() => {
        import("./index-BWOlBhaK.js");
        import("./ProductDisplayEnhancer-erlXlu64.js");
        import("./utils-D7bEf2-B.js").then((n) => n.N);
      }, 1e3);
    }
  });
}
