<<<<<<<< HEAD:dist/chunks/CheckoutFormEnhancer-DU0ZY1kw.js
import { B as BaseEnhancer } from "./index-WbFNZle8.js";
import { a as useCheckoutStore, n as nextAnalytics, E as EcommerceEvents, u as useCartStore, b as useAttributionStore, c as userDataStorage } from "./analytics-BuAKAb38.js";
import { c as createLogger, F as FieldFinder, m as ErrorDisplayManager, n as EventHandlerManager, a as configStore, u as useCampaignStore, C as CountryService, g as useParameterStore } from "./utils-CQa_9vcu.js";
...
import { O as OrderManager, E as ExpressCheckoutProcessor } from "./OrderManager-BywL3-hs.js";
========
import { B as BaseEnhancer } from "./index-B4JTKwBe.js";
import { a as useCheckoutStore, n as nextAnalytics, E as EcommerceEvents, u as useCartStore, b as useAttributionStore, c as userDataStorage } from "./analytics-B6LHWcNI.js";
import { c as createLogger, F as FieldFinder, m as ErrorDisplayManager, n as EventHandlerManager, o as createCloseButton, E as EventBus, a as configStore, u as useCampaignStore, C as CountryService, g as useParameterStore } from "./utils-DvNc5oJP.js";
import { ApiClient } from "./api-VF5M6PDD.js";
import { G as GeneralModal } from "./GeneralModal-Cuk4sJCc.js";
import { L as LoadingOverlay } from "./LoadingOverlay-DOjYiQnB.js";
import { O as OrderManager, E as ExpressCheckoutProcessor } from "./OrderManager-EmBupQLx.js";
>>>>>>>> 7e5c29115709fb63d927fddd1b927f667966c0ea:dist/chunks/CheckoutFormEnhancer-B_MEhSPn.js
import { i as intlTelInput } from "./vendor-Bn6IlrKj.js";
...
class NextCommerceAutocomplete {
  ...
  createInstance(input, fieldKey, defaultCountry, type) {
    try {
      const { fields, billingFields } = this.ctx;
      const countryField = type === "shipping" ? fields.get("country") : billingFields.get("billing-country");
      let countryValue = countryField instanceof HTMLSelectElement && countryField.value ? countryField.value : defaultCountry;
      let abortController = null;
      let debounceTimer = null;
      const addCloseButtonToContainer = () => {
        const pacContainer = document.querySelector(".pac-container-nextcommerce:not([data-close-added])");
        if (!pacContainer) return;
        pacContainer.setAttribute("data-close-added", "true");
        pacContainer.appendChild(createCloseButton(() => {
          pacContainer.style.display = "none";
      ...
      const getOrCreatePacContainer = () => {
        let pac = document.querySelector(".pac-container-nextcommerce.pac-logo");
        if (!pac) {
      ...
      const showSuggestions = async () => {
        ...
        countryValue = countryField instanceof HTMLSelectElement && countryField.value ? countryField.value : defaultCountry;
        ...
        try {
          ...
          pacContainer.replaceChildren(...result.results.map((r) => this.buildItem(r, input, type)));
  ...
  buildHighlightedLabel(text, query) {
    ...
    label.append(...text.split(pattern).map(
  ...
  async setStateWithRetry(stateSelect, stateCode, stateName, attempt = 0) {
    if (attempt >= 5) {
      this.ctx.logger.warn(`Failed to set state ${stateCode} after 5 attempts`);
      return;
    }
  ...
  initializePhoneInput(type, phoneField) {
    try {
      ...
      const instance = intlTelInput(phoneField, {
        ...
        loadUtils: () => import("./vendor-Bn6IlrKj.js").then((n) => n.u),
