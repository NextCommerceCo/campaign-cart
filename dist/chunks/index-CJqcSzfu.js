import { B as BaseActionEnhancer } from "./BaseActionEnhancer-Dh-HpOBD.js";
import { p as preserveQueryParams } from "./utils-JP7GtpcB.js";
import { e as useCartStore } from "./stores-DhBPTw5A.js";
...
async function addToCart(packageId, quantity, ctx) {
  ...
  await cartStore.addItem({ packageId, quantity, isUpsell: void 0, properties: ctx.properties });
...
class AddToCartEnhancer extends BaseActionEnhancer {
  ...
  attachPropertyInputListeners() {
    const handler = (e) => {
      ...
      const isContainer = this.propertyContainerSelector && target.hasAttribute("data-next-property-key") && !!target.closest(this.propertyContainerSelector);
