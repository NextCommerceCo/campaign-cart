import { a as useCartStore, u as useCampaignStore, d as useAttributionStore, b as useCheckoutStore, c as configStore } from "./analytics-D4CaGccD.js";
import { u as useOrderStore, t as testModeManager } from "./debug-DqxJx4_y.js";
import { L as Logger, E as EventBus, u as useParameterStore, c as createLogger, b as CountryService, C as CART_STORAGE_KEY, d as LogLevel } from "./utils-CMIpev9P.js";
...
class NextCommerce {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-D4CaGccD.js").then((n) => n.j);
  ...
  async trackViewItem(packageId) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-D4CaGccD.js").then((n) => n.j);
        const { useCampaignStore: useCampaignStore2 } = await import("./analytics-D4CaGccD.js").then((n) => n.f);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./analytics-D4CaGccD.js").then((n) => n.j);
        nextAnalytics.track(
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-BgvFGQGk.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-BzKtnhuH.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart" || parsed.object === "cart-summary") {
            ...
            const { CartDisplayEnhancer } = await import("./index-b6ZwtD07.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-5jCEY8MM.js");
            ...
            const { PackageSelectorDisplayEnhancer } = await import("./index-DNog9Ibr.js");
            ...
            const { PackageToggleDisplayEnhancer } = await import("./index-ED2stm3f.js");
        ...
        case "package-toggle":
          const { PackageToggleEnhancer } = await import("./index-ED2stm3f.js");
          return new PackageToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./index-Cgqv3OXv.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./index-1l3jaBv5.js");
        ...
        case "package-selector":
          const { PackageSelectorEnhancer } = await import("./index-DNog9Ibr.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-cZGS8An1.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-Cpja84vu.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-CbeWvDQv.js");
        ...
        case "checkout-review":
          ...
          const { CheckoutReviewEnhancer } = await import("./CheckoutReviewEnhancer-D_Wi86Wi.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-CBxCfTz4.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./index-JhMdSmP_.js");
          return new CartItemListEnhancer(element);
        case "cart-summary":
          const { CartSummaryEnhancer } = await import("./index-b6ZwtD07.js");
          return new CartSummaryEnhancer(element);
        case "bundle-selector":
          const { BundleSelectorEnhancer } = await import("./index-B8xFboxh.js");
          return new BundleSelectorEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-CKdCM6cV.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./index-BudIESOe.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./index-BXffbjcl.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./index-D8cq2Bmm.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-DeRp-Axb.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-Crms8OJ7.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-UR6KsJ8h.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-CHFloEdt.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-DU1ulC-Z.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async captureUrlParameters(urlParams) {
    try {
      const { useParameterStore: useParameterStore2 } = await import("./utils-CMIpev9P.js").then((n) => n.z);
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-CMIpev9P.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-CMIpev9P.js").then((n) => n.H).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./debug-DqxJx4_y.js").then((n) => n.D);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./debug-DqxJx4_y.js").then((n) => n.D).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./index-b6ZwtD07.js");
        import("./index-ED2stm3f.js");
        import("./index-DNog9Ibr.js");
        import("./ProductDisplayEnhancer-CrYWUqtI.js");
        import("./SelectionDisplayEnhancer-5jCEY8MM.js");
        import("./TimerEnhancer-cZGS8An1.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-CbeWvDQv.js");
        import("./ExpressCheckoutContainerEnhancer-CBxCfTz4.js");
        import("./OrderDisplayEnhancer-Dfw4pMmy.js");
        import("./index-D8cq2Bmm.js");
        import("./utils-CMIpev9P.js").then((n) => n.B);
        import("./index-JhMdSmP_.js");
        import("./index-BudIESOe.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-Crms8OJ7.js");
        import("./CouponEnhancer-DeRp-Axb.js");
        import("./SimpleExitIntentEnhancer-BgvFGQGk.js");
      }, { timeout: 5e3 });
    } else {
      setTimeout(() => {
        import("./index-b6ZwtD07.js");
        import("./ProductDisplayEnhancer-CrYWUqtI.js");
        import("./utils-CMIpev9P.js").then((n) => n.I);
      }, 1e3);
    }
  });
}
