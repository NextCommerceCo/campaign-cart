import { n as nextAnalytics, E as EcommerceEvents } from "./analytics-PU2fF66s.js";
import { q as getFailureUrl, s as getSuccessUrl, t as handleOrderRedirect } from "./utils-C4PNEPcs.js";
import { d as useCampaignStore, a as configStore, u as useAttributionStore, e as useCartStore, b as useCheckoutStore } from "./stores-T9INJ71u.js";
...
class OrderManager {
  ...
  async createExpressOrder(cartItems, paymentMethod) {
    ...
    try {
      ...
      const { useCheckoutStore: useCheckoutStore2 } = await import("./stores-T9INJ71u.js").then((n) => n.k);
