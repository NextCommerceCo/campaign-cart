...
import { c as createLogger, b as CART_STORAGE_KEY, s as sessionStorageManager, f as formatPercentage, d as formatCurrency, E as EventBus, a as configStore, u as useCampaignStore } from "./utils-BuscMPQd.js";
...
const cartStoreInstance = create()(
  persist(
    subscribeWithSelector((set, get) => ({
      ...initialState$2,
      addItem: async (item) => {
        const { useCampaignStore: useCampaignStore2 } = await import("./utils-BuscMPQd.js").then((n) => n.B);
        const { useProfileStore } = await import("./utils-BuscMPQd.js").then((n) => n.G);
      ...
      applyCoupon: async (code) => {
        const { useConfigStore } = await import("./utils-BuscMPQd.js").then((n) => n.H);
...
const useAttributionStore = create()(
  persist(
    (set, get) => ({
      ...
      initialize: async () => {
        try {
          const { AttributionCollector } = await import("./utils-BuscMPQd.js").then((n) => n.K);
