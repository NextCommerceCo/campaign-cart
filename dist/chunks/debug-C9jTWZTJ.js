import { c as createLogger, L as Logger, b as CountryService, E as EventBus, f as formatCurrency } from "./utils-CrpDcj7g.js";
import { c as configStore, u as useCampaignStore, a as useCartStore, b as useCheckoutStore } from "./analytics-ey_Dovko.js";
import { c as create, p as persist } from "./vendor-CaTqRiSQ.js";
...
class LocaleSelector {
  ...
  async handleLocaleChange(newLocale, isReset = false) {
    ...
    try {
      ...
      const { CurrencyFormatter } = await import("./utils-CrpDcj7g.js").then((n) => n.K);
      CurrencyFormatter.clearCache();
      const { useCartStore: useCartStore2 } = await import("./analytics-ey_Dovko.js").then((n) => n.i);
              ...
              <div class="cart-item-card">
                <div class="item-info">
                  ...
                  ${detail ? `
                      ...
                      ` : offer.description ? `<div class="item-details">${escapeHtml(offer.description)}</div>` : ""}
                </div>
                  ...
                  <div class="cart-item-card">
                    <div class="item-info">
                      ...
                      ${detail ? `
                          ...
                          ` : match?.description ? `<div class="item-details">${escapeHtml(match.description)}</div>` : ""}
                    </div>
