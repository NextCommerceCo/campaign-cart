import { n as nextAnalytics, E as EcommerceEvents, u as useCampaignStore, c as configStore, d as useAttributionStore, a as useCartStore, b as useCheckoutStore } from "./analytics-Cx675Azl.js";
import { r as getFailureUrl, t as getSuccessUrl, v as handleOrderRedirect } from "./utils-CQuX7v7-.js";
...
class OrderManager {
  ...
  async createExpressOrder(cartItems, paymentMethod) {
    ...
    try {
      ...
      const { useCheckoutStore: useCheckoutStore2 } = await import("./analytics-Cx675Azl.js").then((n) => n.g);
