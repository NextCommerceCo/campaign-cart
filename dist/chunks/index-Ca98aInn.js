import { L as Logger, E as EventBus, e as useCartStore, d as useCampaignStore, u as useAttributionStore, b as useCheckoutStore, f as useOrderStore, a as configStore, g as useParameterStore, c as createLogger, C as CART_STORAGE_KEY, h as LogLevel } from "./stores-T9INJ71u.js";
import { ApiClient } from "./api-ypWecDS1.js";
import { t as testModeManager } from "./debug-DnaezYqR.js";
import { C as CountryService } from "./utils-C4PNEPcs.js";
class NextCommerce {
  constructor() {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-PU2fF66s.js").then((n) => n.i);
  ...
  async trackViewItem(packageId) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-PU2fF66s.js").then((n) => n.i);
        const { useCampaignStore: useCampaignStore2 } = await import("./stores-T9INJ71u.js").then((n) => n.j);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./analytics-PU2fF66s.js").then((n) => n.i);
        nextAnalytics.track(
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-UoiVvsyu.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-Bajm2j6i.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart" || parsed.object === "cart-summary") {
            ...
            const { CartDisplayEnhancer } = await import("./index-CWAUcPa7.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-D7sat2JI.js");
            ...
            const { PackageSelectorDisplayEnhancer } = await import("./index-CoBiz-sW.js");
            ...
            const { PackageToggleDisplayEnhancer } = await import("./index-C4BDhLm2.js");
        ...
        case "package-toggle":
          const { PackageToggleEnhancer } = await import("./index-C4BDhLm2.js");
          return new PackageToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./index-R2_D62-3.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./index-z-am5DAB.js");
        ...
        case "package-selector":
          const { PackageSelectorEnhancer } = await import("./index-CoBiz-sW.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-BRk6ZZlE.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-DiJbeAQx.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-yJk4Ux5c.js");
        ...
        case "checkout-review":
          ...
          const { CheckoutReviewEnhancer } = await import("./CheckoutReviewEnhancer-DXLtz45w.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-CDwbAEPh.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./index-CcCzqc__.js");
          return new CartItemListEnhancer(element);
        case "cart-summary":
          const { CartSummaryEnhancer } = await import("./index-CWAUcPa7.js");
          return new CartSummaryEnhancer(element);
        case "bundle-selector":
          const { BundleSelectorEnhancer } = await import("./index-BLHOWxJd.js");
          return new BundleSelectorEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-RXOPoPf9.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./index-OoLp9r2O.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./index-Ds7Suu-k.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./index-D7k4_L42.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-D2sOAyY9.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-Ds_t10pq.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-3PF-9hCH.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-DrIUmtSf.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-WCxJnhcf.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async captureUrlParameters(urlParams) {
    try {
      const { useParameterStore: useParameterStore2 } = await import("./stores-T9INJ71u.js").then((n) => n.p);
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-C4PNEPcs.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-C4PNEPcs.js").then((n) => n.y).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./debug-DnaezYqR.js").then((n) => n.D);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./debug-DnaezYqR.js").then((n) => n.D).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./index-CWAUcPa7.js");
        import("./index-C4BDhLm2.js");
        import("./index-CoBiz-sW.js");
        import("./ProductDisplayEnhancer-C34BLMYS.js");
        import("./SelectionDisplayEnhancer-D7sat2JI.js");
        import("./TimerEnhancer-BRk6ZZlE.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-yJk4Ux5c.js");
        import("./ExpressCheckoutContainerEnhancer-CDwbAEPh.js");
        import("./OrderDisplayEnhancer-Ux2ChZ1F.js");
        import("./index-D7k4_L42.js");
        import("./utils-C4PNEPcs.js").then((n) => n.A);
        import("./index-CcCzqc__.js");
        import("./index-OoLp9r2O.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-Ds_t10pq.js");
        import("./CouponEnhancer-D2sOAyY9.js");
        import("./SimpleExitIntentEnhancer-UoiVvsyu.js");
      }, { timeout: 5e3 });
    } else {
      setTimeout(() => {
        import("./index-CWAUcPa7.js");
        import("./ProductDisplayEnhancer-C34BLMYS.js");
        import("./utils-C4PNEPcs.js").then((n) => n.z);
      }, 1e3);
    }
  });
}
