...
import { u as useCampaignStore, c as configStore } from "./analytics-CyPVhTFQ.js";
...
import { p as preserveQueryParams } from "./utils-DGJWv0Vp.js";
...
class UpsellEnhancer extends BaseEnhancer {
  ...
  async initialize() {
    ...
    this.packageSelectorId = this.getAttribute("data-next-package-selector-id") ?? void 0;
