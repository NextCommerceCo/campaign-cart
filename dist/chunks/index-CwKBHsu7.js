import { a as useCartStore, u as useCampaignStore, e as useAttributionStore, b as useCheckoutStore, c as configStore, d as useProfileStore } from "./analytics-BNQqAdYi.js";
import { u as useOrderStore, t as testModeManager } from "./debug-Wb5oTkdX.js";
import { L as Logger, E as EventBus, u as useParameterStore, c as createLogger, d as CountryService, a as CART_STORAGE_KEY, e as LogLevel } from "./utils-loa9ColJ.js";
import { ApiClient } from "./api-JljKb3HU.js";
class NextCommerce {
  constructor() {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-BNQqAdYi.js").then((n) => n.i);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./analytics-BNQqAdYi.js").then((n) => n.i);
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-CUaJATLV.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-BF_sT99Z.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-zrBHydiS.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-BAxTI4vS.js");
        ...
        case "toggle":
          const { CartToggleEnhancer } = await import("./CartToggleEnhancer-TgFe4Pty.js");
          return new CartToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./AddToCartEnhancer-DD6I6A16.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-BiMhrBfY.js");
        ...
        case "selector":
          const { PackageSelectorEnhancer } = await import("./PackageSelectorEnhancer-DcJUsmhS.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-BkWW76t2.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-DsoTHws6.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-J_xO66ZL.js");
        ...
        case "checkout-review":
          ...
          const { CheckoutReviewEnhancer } = await import("./CheckoutReviewEnhancer-CADCakKL.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-BSZR1ug-.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-N_pCnxQD.js");
          return new CartItemListEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-DHkMvf4c.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./QuantityControlEnhancer-BoPy3lm8.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./RemoveItemEnhancer-DrwzJiOq.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-wE0CH8OC.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-D889JDJC.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-QFWkuinQ.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-DTW7VgCY.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-DYOYpcWM.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-IT345jRu.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async captureUrlParameters(urlParams) {
    try {
      const { useParameterStore: useParameterStore2 } = await import("./utils-loa9ColJ.js").then((n) => n.A);
  ...
  static async processProfileParameter() {
    ...
    if (configStore$1.profiles && Object.keys(configStore$1.profiles).length > 0) {
      const { useProfileStore: useProfileStore22 } = await import("./analytics-BNQqAdYi.js").then((n) => n.p);
    ...
    const { useProfileStore: useProfileStore2 } = await import("./analytics-BNQqAdYi.js").then((n) => n.p);
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-loa9ColJ.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-loa9ColJ.js").then((n) => n.G).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./debug-Wb5oTkdX.js").then((n) => n.D);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./debug-Wb5oTkdX.js").then((n) => n.D).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-zrBHydiS.js");
        import("./CartToggleEnhancer-TgFe4Pty.js");
        import("./PackageSelectorEnhancer-DcJUsmhS.js");
        import("./ProductDisplayEnhancer-BlRbWzEK.js");
        import("./SelectionDisplayEnhancer-BAxTI4vS.js");
        import("./TimerEnhancer-BkWW76t2.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-J_xO66ZL.js");
        import("./ExpressCheckoutContainerEnhancer-BSZR1ug-.js");
        import("./OrderDisplayEnhancer-CSgkMCpd.js");
        import("./UpsellEnhancer-wE0CH8OC.js");
        import("./utils-loa9ColJ.js").then((n) => n.B);
        import("./CartItemListEnhancer-N_pCnxQD.js");
        import("./QuantityControlEnhancer-BoPy3lm8.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-QFWkuinQ.js");
        import("./CouponEnhancer-D889JDJC.js");
        import("./SimpleExitIntentEnhancer-CUaJATLV.js");
      ...
      setTimeout(() => {
        import("./CartDisplayEnhancer-zrBHydiS.js");
        import("./ProductDisplayEnhancer-BlRbWzEK.js");
        import("./utils-loa9ColJ.js").then((n) => n.H);
      }, 1e3);
    }
  });
}
