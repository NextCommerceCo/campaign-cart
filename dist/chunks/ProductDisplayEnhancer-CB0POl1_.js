<<<<<<<< HEAD:dist/chunks/ProductDisplayEnhancer-MNbNwkiS.js
import { B as BaseDisplayEnhancer, D as DisplayFormatter, P as PropertyResolver, a as getPropertyMapping } from "./DisplayEnhancerCore-Dk1lw7fW.js";
import { A as AttributeParser } from "./index-WbFNZle8.js";
import { u as useCampaignStore, e as useProfileStore, j as PackageContextResolver, l as PriceCalculator } from "./utils-CQa_9vcu.js";
import { u as useCartStore } from "./analytics-BuAKAb38.js";
========
import { B as BaseDisplayEnhancer, D as DisplayFormatter, P as PropertyResolver, a as getPropertyMapping } from "./DisplayEnhancerCore-BAs6lwka.js";
import { A as AttributeParser } from "./index-B4JTKwBe.js";
import { u as useCampaignStore, e as useProfileStore, j as PackageContextResolver, l as PriceCalculator } from "./utils-DvNc5oJP.js";
import { u as useCartStore } from "./analytics-B6LHWcNI.js";
>>>>>>>> 7e5c29115709fb63d927fddd1b927f667966c0ea:dist/chunks/ProductDisplayEnhancer-CB0POl1_.js
...
class ProductDisplayEnhancer extends BaseDisplayEnhancer {
  ...
  loadPackageData() {
    ...
    this.originalPackageData = packages?.find((pkg) => pkg.ref_id === this.packageId);
    ...
    this.packageData = packages?.find((pkg) => pkg.ref_id === targetPackageId);
    if (!this.packageData && mappedPackageId !== this.packageId) {
      const campaignStore = useCampaignStore.getState();
      if (campaignStore.data?.packages) {
        this.packageData = campaignStore.data.packages.find((pkg) => pkg.ref_id === targetPackageId);
        if (this.packageData) {
    ...
    if (!this.packageData) {
      ...
      const availableIds = packages?.map((p) => p.ref_id).join(", ");
  ...
  calculateProfileAwareSavingsPercentage() {
    if (!this.originalPackageData || !this.packageData) return 0;
    const originalRetailTotal = parseFloat(this.originalPackageData.price_retail_total || "0") || parseFloat(this.originalPackageData.price_retail || "0");
    const currentSaleTotal = parseFloat(this.packageData.price_total || "0") || parseFloat(this.packageData.price || "0");
