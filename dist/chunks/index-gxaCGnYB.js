import { B as BaseDisplayEnhancer, g as getPropertyMapping, D as DisplayFormatter, P as PropertyResolver } from "./base-display-enhancer-CrLIAYC7.js";
...
import { a as useCampaignStore, d as useCartStore } from "./state-pM9xfsfc.js";
  ...
  getCalculatedProperty(property) {
    ...
    switch (property) {
      ...
      case "savingsAmount":
        return metrics.totalSavings;
      case "savingsPercentage":
        this.logger.debug(`Savings percentage: ${metrics.totalSavingsPercentage}%`);
        return metrics.totalSavingsPercentage;
      case "unitPrice":
      ...
      case "unitSavingsPercentage":
        this.logger.debug("Returning unitSavingsPercentage", {
