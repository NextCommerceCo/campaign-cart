import { a as useCartStore, u as useCampaignStore, d as useAttributionStore, b as useCheckoutStore, c as configStore } from "./analytics-ey_Dovko.js";
import { u as useOrderStore, t as testModeManager } from "./debug-C9jTWZTJ.js";
import { L as Logger, E as EventBus, u as useParameterStore, c as createLogger, b as CountryService, C as CART_STORAGE_KEY, d as LogLevel } from "./utils-CrpDcj7g.js";
...
class NextCommerce {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-ey_Dovko.js").then((n) => n.j);
  ...
  async trackViewItem(packageId) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-ey_Dovko.js").then((n) => n.j);
        const { useCampaignStore: useCampaignStore2 } = await import("./analytics-ey_Dovko.js").then((n) => n.f);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./analytics-ey_Dovko.js").then((n) => n.j);
        nextAnalytics.track(
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-Bkg_ZX7u.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-Ce7fOUla.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart" || parsed.object === "cart-summary") {
            ...
            const { CartDisplayEnhancer } = await import("./index-B3-xQ0a6.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-CqYA8rse.js");
            ...
            const { PackageSelectorDisplayEnhancer } = await import("./index-Dvv9Oa5H.js");
            ...
            const { PackageToggleDisplayEnhancer } = await import("./index-BziizJFE.js");
        ...
        case "package-toggle":
          const { PackageToggleEnhancer } = await import("./index-BziizJFE.js");
          return new PackageToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./index-6b5_bH76.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./index-D_fxzd7i.js");
        ...
        case "package-selector":
          const { PackageSelectorEnhancer } = await import("./index-Dvv9Oa5H.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-BZmJgcP5.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-DWeETTHC.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-CP68aBsX.js");
        ...
        case "checkout-review":
          ...
          const { CheckoutReviewEnhancer } = await import("./CheckoutReviewEnhancer-CiNrxcBs.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-DtaDw1nA.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./index-jVe40Z2d.js");
          return new CartItemListEnhancer(element);
        case "cart-summary":
          const { CartSummaryEnhancer } = await import("./index-B3-xQ0a6.js");
          return new CartSummaryEnhancer(element);
        case "bundle-selector":
          const { BundleSelectorEnhancer } = await import("./index-B4MFv8oo.js");
          return new BundleSelectorEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-DvbSGXVP.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./index-B7HxBayq.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./index-CnWxzbB9.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./index-BbCnkddb.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-B6KVtQsX.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-BfJmX-qQ.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-CLLT85Eu.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-Dtw00gqL.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-B29EEuHE.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async captureUrlParameters(urlParams) {
    try {
      const { useParameterStore: useParameterStore2 } = await import("./utils-CrpDcj7g.js").then((n) => n.H);
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-CrpDcj7g.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-CrpDcj7g.js").then((n) => n.M).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./debug-C9jTWZTJ.js").then((n) => n.D);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./debug-C9jTWZTJ.js").then((n) => n.D).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./index-B3-xQ0a6.js");
        import("./index-BziizJFE.js");
        import("./index-Dvv9Oa5H.js");
        import("./ProductDisplayEnhancer-BcLIUA-Z.js");
        import("./SelectionDisplayEnhancer-CqYA8rse.js");
        import("./TimerEnhancer-BZmJgcP5.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-CP68aBsX.js");
        import("./ExpressCheckoutContainerEnhancer-DtaDw1nA.js");
        import("./OrderDisplayEnhancer-DO9Uj6ZK.js");
        import("./index-BbCnkddb.js");
        import("./utils-CrpDcj7g.js").then((n) => n.J);
        import("./index-jVe40Z2d.js");
        import("./index-B7HxBayq.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-BfJmX-qQ.js");
        import("./CouponEnhancer-B6KVtQsX.js");
        import("./SimpleExitIntentEnhancer-Bkg_ZX7u.js");
      }, { timeout: 5e3 });
    } else {
      setTimeout(() => {
        import("./index-B3-xQ0a6.js");
        import("./ProductDisplayEnhancer-BcLIUA-Z.js");
        import("./utils-CrpDcj7g.js").then((n) => n.N);
      }, 1e3);
    }
  });
}
