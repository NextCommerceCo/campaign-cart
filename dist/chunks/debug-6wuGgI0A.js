import { c as createLogger, L as Logger, C as CountryService, E as EventBus, f as formatCurrency } from "./utils-D7bEf2-B.js";
import { c as configStore, u as useCampaignStore, a as useCartStore, b as useCheckoutStore } from "./analytics-DDBbK97v.js";
import { c as create, p as persist } from "./vendor-DBG5xMk9.js";
...
class LocaleSelector {
  ...
  async handleLocaleChange(newLocale, isReset = false) {
    ...
    try {
      ...
      const { CurrencyFormatter } = await import("./utils-D7bEf2-B.js").then((n) => n.K);
      CurrencyFormatter.clearCache();
      const { useCartStore: useCartStore2 } = await import("./analytics-DDBbK97v.js").then((n) => n.i);
