...
import { L as Logger } from "./analytics-DdhZlX6_.js";
import { f as formatCurrency, d as formatNumber, e as CurrencyFormatter } from "./debug-DwIz_ASh.js";
const PROPERTY_MAPPINGS = {
  ...
  cart: {
    ...
    discounts: { path: "totalDiscount", format: "currency" },
    // alias
    ...
    hasCoupon: { path: "vouchers.length", format: "boolean", validator: (v) => v > 0 },
...
const _DisplayValueValidator = class _DisplayValueValidator {
...
_DisplayValueValidator.logger = new Logger("DisplayValueValidator");
let DisplayValueValidator = _DisplayValueValidator;
...
const _DisplayFormatter = class _DisplayFormatter {
  ...
  static formatCurrency(value, hideZeroCents) {
    ...
    return formatCurrency(numValue, void 0, hideZeroCents !== void 0 ? { hideZeroCents } : {});
  }
