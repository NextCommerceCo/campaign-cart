...
import { u as useCampaignStore, a as useCartStore, b as useCheckoutStore, c as configStore } from "./analytics-Cx675Azl.js";
import { T as TemplateRenderer, f as formatCurrency, e as calculateBundlePrice, p as preserveQueryParams } from "./utils-CQuX7v7-.js";
import { u as useOrderStore } from "./debug-CmN56jBA.js";
import { ApiClient } from "./api-CEuy-6ZK.js";
import { B as BaseDisplayEnhancer } from "./DisplayEnhancerCore-s5fHn6uF.js";
...
function renderTogglePrice(card, line) {
  ...
  const savingsPct = savings > 0 && compareNum ? savings / compareNum * 100 : 0;
...
class PackageToggleDisplayEnhancer extends BaseDisplayEnhancer {
  ...
  resolveCardEl() {
    ...
    this.cardEl = document.querySelector(
  ...
  getPropertyValue() {
    ...
    switch (this.property) {
      ...
      case "price":
        return parseFloat(this.cardEl.getAttribute("data-toggle-price-total") ?? "") || void 0;
      case "compare":
        return parseFloat(this.cardEl.getAttribute("data-toggle-price-compare") ?? "") || void 0;
      case "savings":
        return parseFloat(this.cardEl.getAttribute("data-toggle-price-savings") ?? "") || void 0;
      case "savingsPercentage":
        return parseFloat(this.cardEl.getAttribute("data-toggle-price-savings-pct") ?? "") || void 0;
      case "hasSavings":
        return (parseFloat(this.cardEl.getAttribute("data-toggle-price-savings") ?? "0") || 0) > 0;
      default:
