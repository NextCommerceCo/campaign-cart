import { L as Logger, a as configStore, d as useCampaignStore, e as useCartStore, E as EventBus, f as useOrderStore, b as useCheckoutStore } from "./stores-DhBPTw5A.js";
import { C as CountryService, f as formatCurrency } from "./utils-JP7GtpcB.js";
...
class LocaleSelector {
  ...
  async handleLocaleChange(newLocale, isReset = false) {
    ...
    try {
      ...
      const { CurrencyFormatter } = await import("./utils-JP7GtpcB.js").then((n) => n.x);
      CurrencyFormatter.clearCache();
      const { useCartStore: useCartStore2 } = await import("./stores-DhBPTw5A.js").then((n) => n.i);
