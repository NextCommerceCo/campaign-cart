import { a as useCartStore, u as useCampaignStore, e as useAttributionStore, b as useCheckoutStore, c as configStore, d as useProfileStore } from "./analytics-nekWyYfO.js";
import { u as useOrderStore, t as testModeManager } from "./debug-Bs4EMzZ3.js";
import { L as Logger, E as EventBus, u as useParameterStore, c as createLogger, b as CountryService, C as CART_STORAGE_KEY, d as LogLevel } from "./utils-DlFSJDpc.js";
import { ApiClient } from "./api-BsFWyyhT.js";
class NextCommerce {
  constructor() {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-nekWyYfO.js").then((n) => n.k);
  ...
  async trackViewItem(packageId) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-nekWyYfO.js").then((n) => n.k);
        const { useCampaignStore: useCampaignStore2 } = await import("./analytics-nekWyYfO.js").then((n) => n.h);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./analytics-nekWyYfO.js").then((n) => n.k);
        nextAnalytics.track(
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-C3dp6NNA.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-vN82sbh4.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-CQmhiHE9.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-Q5O84V7w.js");
        ...
        case "package-toggle":
          const { PackageToggleEnhancer } = await import("./PackageToggleEnhancer-CzOXrnPS.js");
          return new PackageToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./AddToCartEnhancer-BNiXpfy1.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-CIYqj_17.js");
        ...
        case "package-selector":
          const { PackageSelectorEnhancer } = await import("./PackageSelectorEnhancer-DkJpGWFt.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-ciQCgDNa.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-CxboZ_MW.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-DB_0oTaN.js");
        ...
        case "checkout-review":
          ...
          const { CheckoutReviewEnhancer } = await import("./CheckoutReviewEnhancer-CJObl-Hg.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-MZd4upNo.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-DAg3pQFc.js");
          return new CartItemListEnhancer(element);
        case "cart-summary":
          const { CartSummaryEnhancer } = await import("./CartSummaryEnhancer-yJAwLHS0.js");
          return new CartSummaryEnhancer(element);
        case "bundle-selector":
          const { BundleSelectorEnhancer } = await import("./BundleSelectorEnhancer-i4q8d1t1.js");
          return new BundleSelectorEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-DuOuqZiC.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./QuantityControlEnhancer-lNDZfMtQ.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./RemoveItemEnhancer-CNnUiTZ7.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-aPAwf9se.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-DXirFvZI.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-CkG7-4YG.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-CUIPxyaU.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-BtvnnQkg.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-B4kaTB2Z.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async captureUrlParameters(urlParams) {
    try {
      const { useParameterStore: useParameterStore2 } = await import("./utils-DlFSJDpc.js").then((n) => n.A);
  ...
  static async processProfileParameter() {
    ...
    if (configStore$1.profiles && Object.keys(configStore$1.profiles).length > 0) {
      const { useProfileStore: useProfileStore22 } = await import("./analytics-nekWyYfO.js").then((n) => n.p);
    ...
    const { useProfileStore: useProfileStore2 } = await import("./analytics-nekWyYfO.js").then((n) => n.p);
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-DlFSJDpc.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-DlFSJDpc.js").then((n) => n.I).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./debug-Bs4EMzZ3.js").then((n) => n.D);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./debug-Bs4EMzZ3.js").then((n) => n.D).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-CQmhiHE9.js");
        import("./PackageToggleEnhancer-CzOXrnPS.js");
        import("./PackageSelectorEnhancer-DkJpGWFt.js");
        import("./ProductDisplayEnhancer-DmB9ZYfM.js");
        import("./SelectionDisplayEnhancer-Q5O84V7w.js");
        import("./TimerEnhancer-ciQCgDNa.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-DB_0oTaN.js");
        import("./ExpressCheckoutContainerEnhancer-MZd4upNo.js");
        import("./OrderDisplayEnhancer-lrP4nDiH.js");
        import("./UpsellEnhancer-aPAwf9se.js");
        import("./utils-DlFSJDpc.js").then((n) => n.H);
        import("./CartItemListEnhancer-DAg3pQFc.js");
        import("./QuantityControlEnhancer-lNDZfMtQ.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-CkG7-4YG.js");
        import("./CouponEnhancer-DXirFvZI.js");
        import("./SimpleExitIntentEnhancer-C3dp6NNA.js");
      ...
      setTimeout(() => {
        import("./CartDisplayEnhancer-CQmhiHE9.js");
        import("./ProductDisplayEnhancer-DmB9ZYfM.js");
        import("./utils-DlFSJDpc.js").then((n) => n.J);
      }, 1e3);
    }
  });
}
