import { L as Logger, E as EventBus, e as useCartStore, b as useCampaignStore, u as useAttributionStore, d as useCheckoutStore, f as useOrderStore, a as configStore, g as useParameterStore, c as createLogger, C as CART_STORAGE_KEY, h as LogLevel } from "./stores-CgBkvYdT.js";
import { ApiClient } from "./api-BdeHYK3t.js";
import { t as testModeManager } from "./debug-D8amBFt6.js";
import { C as CountryService } from "./utils-D0Guuvf0.js";
class NextCommerce {
  constructor() {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-Buzgs8AR.js").then((n) => n.i);
  ...
  async trackViewItem(packageId) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-Buzgs8AR.js").then((n) => n.i);
        const { useCampaignStore: useCampaignStore2 } = await import("./stores-CgBkvYdT.js").then((n) => n.j);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./analytics-Buzgs8AR.js").then((n) => n.i);
        nextAnalytics.track(
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-CZ67UixY.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-CbzGK_ue.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart" || parsed.object === "cart-summary") {
            ...
            const { CartDisplayEnhancer } = await import("./index-Csbj-WOa.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-CZSah6ax.js");
            ...
            const { PackageSelectorDisplayEnhancer } = await import("./index-DFLvI0Xd.js");
            ...
            const { PackageToggleDisplayEnhancer } = await import("./index-Cvo3tWpF.js");
        ...
        case "package-toggle":
          const { PackageToggleEnhancer } = await import("./index-Cvo3tWpF.js");
          return new PackageToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./index-Cyr8OnVQ.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./index-CeF3-DAN.js");
        ...
        case "package-selector":
          const { PackageSelectorEnhancer } = await import("./index-DFLvI0Xd.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-MrEDx-qo.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-CXSnOu_K.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-BPAVwlIw.js");
        ...
        case "checkout-review":
          ...
          const { CheckoutReviewEnhancer } = await import("./CheckoutReviewEnhancer-ChjiStVr.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-9_eAqgnQ.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./index-CIGXciIo.js");
          return new CartItemListEnhancer(element);
        case "cart-summary":
          const { CartSummaryEnhancer } = await import("./index-Csbj-WOa.js");
          return new CartSummaryEnhancer(element);
        case "bundle-selector":
          const { BundleSelectorEnhancer } = await import("./index-WVOKx8Ph.js");
          return new BundleSelectorEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-DZ4YAU4Z.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./index-C5CmdssR.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./index-WyqM0opf.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./index-CS6TChNN.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-BQ-M-iZC.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-9ZhK2LH9.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-D23ymoLw.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-CsOlB_ZW.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-DdlHJ2oN.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async captureUrlParameters(urlParams) {
    try {
      const { useParameterStore: useParameterStore2 } = await import("./stores-CgBkvYdT.js").then((n) => n.p);
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-D0Guuvf0.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-D0Guuvf0.js").then((n) => n.y).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./debug-D8amBFt6.js").then((n) => n.D);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./debug-D8amBFt6.js").then((n) => n.D).then((m) => m.debugOverlay),
...
const VERSION = typeof window !== "undefined" && window.__NEXT_SDK_VERSION__ ? window.__NEXT_SDK_VERSION__ : "0.4.29";
if (typeof window !== "undefined") {
  if (document.readyState === "loading") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./index-Csbj-WOa.js");
        import("./index-Cvo3tWpF.js");
        import("./index-DFLvI0Xd.js");
        import("./ProductDisplayEnhancer-Bhfh6dZR.js");
        import("./SelectionDisplayEnhancer-CZSah6ax.js");
        import("./TimerEnhancer-MrEDx-qo.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-BPAVwlIw.js");
        import("./ExpressCheckoutContainerEnhancer-9_eAqgnQ.js");
        import("./OrderDisplayEnhancer-QpNLmh7n.js");
        import("./index-CS6TChNN.js");
        import("./utils-D0Guuvf0.js").then((n) => n.A);
        import("./index-CIGXciIo.js");
        import("./index-C5CmdssR.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-9ZhK2LH9.js");
        import("./CouponEnhancer-BQ-M-iZC.js");
        import("./SimpleExitIntentEnhancer-CZ67UixY.js");
      }, { timeout: 5e3 });
    } else {
      setTimeout(() => {
        import("./index-Csbj-WOa.js");
        import("./ProductDisplayEnhancer-Bhfh6dZR.js");
        import("./utils-D0Guuvf0.js").then((n) => n.z);
      }, 1e3);
    }
  });
}
