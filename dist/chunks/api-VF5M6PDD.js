<<<<<<<< HEAD:dist/chunks/api-ChQ3gQf5.js
import { c as createLogger } from "./utils-CQa_9vcu.js";
========
import { c as createLogger } from "./utils-DvNc5oJP.js";
>>>>>>>> 7e5c29115709fb63d927fddd1b927f667966c0ea:dist/chunks/api-VF5M6PDD.js
class ApiClient {
  constructor(apiKey) {
  ...
  async calculateSummary(data) {
    return this.request("/api/v1/carts/calculate/", {
      method: "POST",
      body: JSON.stringify(data)
    });
  }
  ...
  async getAddressesAutocomplete(query_text, country, language, signal) {
    const params = new URLSearchParams({ query_text });
    if (country) params.append("country", country);
    if (language) params.append("language", language);
    return this.request(`/api/v1/addresses/autocomplete/?${params.toString()}`, { signal });
  }
