import { L as Logger, E as EventBus, e as useCartStore, a as useCampaignStore, d as useAttributionStore, u as useCheckoutStore, f as useOrderStore, b as configStore, g as useParameterStore, c as createLogger, C as CART_STORAGE_KEY, h as LogLevel } from "./stores-ow46YhGU.js";
import { ApiClient } from "./api-5oohVhC-.js";
import { t as testModeManager } from "./debug-DFPUkzcB.js";
import { C as CountryService } from "./utils-BfE7Qi7b.js";
class NextCommerce {
  constructor() {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-Bh09LY-K.js").then((n) => n.i);
  ...
  async trackViewItem(packageId) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-Bh09LY-K.js").then((n) => n.i);
        const { useCampaignStore: useCampaignStore2 } = await import("./stores-ow46YhGU.js").then((n) => n.j);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./analytics-Bh09LY-K.js").then((n) => n.i);
        nextAnalytics.track(
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-B-i5q9kE.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-BDGkPDEq.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart" || parsed.object === "cart-summary") {
            ...
            const { CartDisplayEnhancer } = await import("./index-D17XERFb.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-D4un8bqZ.js");
            ...
            const { PackageSelectorDisplayEnhancer } = await import("./index-D4y5oWvZ.js");
            ...
            const { PackageToggleDisplayEnhancer } = await import("./index-XJ54XgD_.js");
        ...
        case "package-toggle":
          const { PackageToggleEnhancer } = await import("./index-XJ54XgD_.js");
          return new PackageToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./index-BOOrKdmv.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./index-Bw9HnyQ7.js");
        ...
        case "package-selector":
          const { PackageSelectorEnhancer } = await import("./index-D4y5oWvZ.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-a5htnWUy.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-DyMVAofN.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-yhK3NSqq.js");
        ...
        case "checkout-review":
          ...
          const { CheckoutReviewEnhancer } = await import("./CheckoutReviewEnhancer-GKJ7dpXh.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-nU70ypZ7.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./index-Dcc1H3lE.js");
          return new CartItemListEnhancer(element);
        case "cart-summary":
          const { CartSummaryEnhancer } = await import("./index-D17XERFb.js");
          return new CartSummaryEnhancer(element);
        case "bundle-selector":
          const { BundleSelectorEnhancer } = await import("./index-op46uJiK.js");
          return new BundleSelectorEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-6NFJoM3M.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./index-BqpHvTBt.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./index-Cr0ghalX.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./index-DWLucDzg.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-u0DoYzwb.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-kgLyL5SX.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-Cy0y6e44.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-BTc8laES.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-CkmoKA0N.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async captureUrlParameters(urlParams) {
    try {
      const { useParameterStore: useParameterStore2 } = await import("./stores-ow46YhGU.js").then((n) => n.p);
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-BfE7Qi7b.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-BfE7Qi7b.js").then((n) => n.z).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./debug-DFPUkzcB.js").then((n) => n.D);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./debug-DFPUkzcB.js").then((n) => n.D).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./index-D17XERFb.js");
        import("./index-XJ54XgD_.js");
        import("./index-D4y5oWvZ.js");
        import("./ProductDisplayEnhancer-vAg7iu5h.js");
        import("./SelectionDisplayEnhancer-D4un8bqZ.js");
        import("./TimerEnhancer-a5htnWUy.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-yhK3NSqq.js");
        import("./ExpressCheckoutContainerEnhancer-nU70ypZ7.js");
        import("./OrderDisplayEnhancer-B285jcMl.js");
        import("./index-DWLucDzg.js");
        import("./utils-BfE7Qi7b.js").then((n) => n.A);
        import("./index-Dcc1H3lE.js");
        import("./index-BqpHvTBt.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-kgLyL5SX.js");
        import("./CouponEnhancer-u0DoYzwb.js");
        import("./SimpleExitIntentEnhancer-B-i5q9kE.js");
      }, { timeout: 5e3 });
    } else {
      setTimeout(() => {
        import("./index-D17XERFb.js");
        import("./ProductDisplayEnhancer-vAg7iu5h.js");
        import("./utils-BfE7Qi7b.js").then((n) => n.B);
      }, 1e3);
    }
  });
}
