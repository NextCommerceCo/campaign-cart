import { n as nextAnalytics, E as EcommerceEvents, u as useCampaignStore, c as configStore, d as useAttributionStore, a as useCartStore, b as useCheckoutStore } from "./analytics-DDBbK97v.js";
import { x as getFailureUrl, y as getSuccessUrl, z as handleOrderRedirect } from "./utils-D7bEf2-B.js";
...
class OrderManager {
  ...
  async createExpressOrder(cartItems, paymentMethod) {
    ...
    try {
      ...
      const { useCheckoutStore: useCheckoutStore2 } = await import("./analytics-DDBbK97v.js").then((n) => n.g);
