import { a as useCartStore, u as useCampaignStore, d as useAttributionStore, c as configStore, b as useProfileStore } from "./analytics-oP9thflZ.js";
import { u as useCheckoutStore, a as useOrderStore, t as testModeManager } from "./debug-C22movfG.js";
import { c as create, p as persist } from "./vendor-SXWB56lk.js";
import { c as createLogger, L as Logger, E as EventBus, d as CountryService, a as CART_STORAGE_KEY, e as LogLevel } from "./utils-B9O2c6Dq.js";
import { ApiClient } from "./api-SLc82Mkw.js";
...
class NextCommerce {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-oP9thflZ.js").then((n) => n.i);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./analytics-oP9thflZ.js").then((n) => n.i);
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-CQTEztJ8.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-C_YFhXXg.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-CkOP87j9.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-DjdrA73z.js");
        ...
        case "toggle":
          const { CartToggleEnhancer } = await import("./CartToggleEnhancer-CuBKXh-L.js");
          return new CartToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./AddToCartEnhancer-DwB2fDlI.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-CzUn7NgH.js");
        ...
        case "selector":
          const { PackageSelectorEnhancer } = await import("./PackageSelectorEnhancer-BMi9n3z0.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-BfN7XpTp.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-FpWlHreY.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-Buyuo_s_.js");
        ...
        case "checkout-review":
          ...
          const { CheckoutReviewEnhancer } = await import("./CheckoutReviewEnhancer-VGnGDEz1.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-Q9PlenlP.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-CSBzgGhw.js");
          return new CartItemListEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-DDHeHzyW.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./QuantityControlEnhancer-I97mN-9O.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./RemoveItemEnhancer-DlPkvW3b.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-C0Hx3D6Q.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-ZXo48RDj.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-yIm2be5J.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-DbrtpaDP.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-DvsByFTH.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-Br0smVvz.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async processProfileParameter() {
    ...
    if (configStore$1.profiles && Object.keys(configStore$1.profiles).length > 0) {
      const { useProfileStore: useProfileStore22 } = await import("./analytics-oP9thflZ.js").then((n) => n.p);
    ...
    const { useProfileStore: useProfileStore2 } = await import("./analytics-oP9thflZ.js").then((n) => n.p);
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-B9O2c6Dq.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-B9O2c6Dq.js").then((n) => n.z).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./debug-C22movfG.js").then((n) => n.D);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./debug-C22movfG.js").then((n) => n.D).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-CkOP87j9.js");
        import("./CartToggleEnhancer-CuBKXh-L.js");
        import("./PackageSelectorEnhancer-BMi9n3z0.js");
        import("./ProductDisplayEnhancer-U5s2nUe_.js");
        import("./SelectionDisplayEnhancer-DjdrA73z.js");
        import("./TimerEnhancer-BfN7XpTp.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-Buyuo_s_.js");
        import("./ExpressCheckoutContainerEnhancer-Q9PlenlP.js");
        import("./OrderDisplayEnhancer-B2Jh8VgT.js");
        import("./UpsellEnhancer-C0Hx3D6Q.js");
        import("./utils-B9O2c6Dq.js").then((n) => n.A);
        import("./CartItemListEnhancer-CSBzgGhw.js");
        import("./QuantityControlEnhancer-I97mN-9O.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-yIm2be5J.js");
        import("./CouponEnhancer-ZXo48RDj.js");
        import("./SimpleExitIntentEnhancer-CQTEztJ8.js");
      ...
      setTimeout(() => {
        import("./CartDisplayEnhancer-CkOP87j9.js");
        import("./ProductDisplayEnhancer-U5s2nUe_.js");
        import("./utils-B9O2c6Dq.js").then((n) => n.B);
      }, 1e3);
    }
  });
}
