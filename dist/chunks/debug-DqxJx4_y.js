import { c as createLogger, L as Logger, b as CountryService, E as EventBus, f as formatCurrency } from "./utils-CMIpev9P.js";
import { c as configStore, u as useCampaignStore, a as useCartStore, b as useCheckoutStore } from "./analytics-D4CaGccD.js";
import { c as create, p as persist } from "./vendor-BvX3PoQU.js";
...
class LocaleSelector {
  ...
  async handleLocaleChange(newLocale, isReset = false) {
    ...
    try {
      ...
      const { CurrencyFormatter } = await import("./utils-CMIpev9P.js").then((n) => n.G);
      CurrencyFormatter.clearCache();
      const { useCartStore: useCartStore2 } = await import("./analytics-D4CaGccD.js").then((n) => n.i);
