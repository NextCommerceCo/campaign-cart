import { n as nextAnalytics, E as EcommerceEvents, u as useCampaignStore, c as configStore, d as useAttributionStore, a as useCartStore } from "./analytics-HEjue3qx.js";
import { q as getFailureUrl, r as getSuccessUrl, t as handleOrderRedirect } from "./utils-BRNcNidD.js";
...
class OrderManager {
  ...
  async createExpressOrder(cartItems, paymentMethod) {
    ...
    try {
      ...
      const { useCartStore: useCartStore2 } = await import("./analytics-HEjue3qx.js").then((n) => n.f);
