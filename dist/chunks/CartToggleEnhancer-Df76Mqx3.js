<<<<<<<< HEAD:dist/chunks/CartToggleEnhancer-nFVb7lbO.js
...
>>>>>>>> 7e5c29115709fb63d927fddd1b927f667966c0ea:dist/chunks/CartToggleEnhancer-Df76Mqx3.js
    ...
    if (anySyncedItemExists && totalSyncQuantity > 0) {
      ...
      if (currentItem.is_upsell) {
        ...
        setTimeout(async () => {
          ...
          this.syncPackageIds.forEach((syncId) => {
            const syncedItem = updatedState.items.find(
              (item) => item.packageId === syncId || item.originalPackageId === syncId
            );
            if (syncedItem) {
