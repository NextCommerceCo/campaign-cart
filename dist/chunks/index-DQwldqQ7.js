import { L as Logger, E as EventBus, e as useCartStore, d as useCampaignStore, u as useAttributionStore, b as useCheckoutStore, f as useOrderStore, a as configStore, g as useParameterStore, c as createLogger, C as CART_STORAGE_KEY, h as LogLevel } from "./stores-DhBPTw5A.js";
import { ApiClient } from "./api-DS8VM9Yk.js";
import { t as testModeManager } from "./debug-DFHmnLQ4.js";
import { C as CountryService } from "./utils-JP7GtpcB.js";
class NextCommerce {
  constructor() {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-CDawIxrg.js").then((n) => n.i);
  ...
  async trackViewItem(packageId) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-CDawIxrg.js").then((n) => n.i);
        const { useCampaignStore: useCampaignStore2 } = await import("./stores-DhBPTw5A.js").then((n) => n.j);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./analytics-CDawIxrg.js").then((n) => n.i);
        nextAnalytics.track(
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-BPnWvl-H.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-FrY636cU.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart" || parsed.object === "cart-summary") {
            ...
            const { CartDisplayEnhancer } = await import("./index-lV2ZpjcR.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-ClSbVc7z.js");
            ...
            const { PackageSelectorDisplayEnhancer } = await import("./index-BWMwS6MD.js");
            ...
            const { PackageToggleDisplayEnhancer } = await import("./index-CSyzn4jB.js");
        ...
        case "package-toggle":
          const { PackageToggleEnhancer } = await import("./index-CSyzn4jB.js");
          return new PackageToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./index-CJqcSzfu.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./index-D_T6oNb_.js");
        ...
        case "package-selector":
          const { PackageSelectorEnhancer } = await import("./index-BWMwS6MD.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-7-UNxZqE.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-GIQ1IJei.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-CGVoVPQ8.js");
        ...
        case "checkout-review":
          ...
          const { CheckoutReviewEnhancer } = await import("./CheckoutReviewEnhancer-EFDxunJD.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-DmlNX_jt.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./index-BYOcA8vv.js");
          return new CartItemListEnhancer(element);
        case "cart-summary":
          const { CartSummaryEnhancer } = await import("./index-lV2ZpjcR.js");
          return new CartSummaryEnhancer(element);
        case "bundle-selector":
          const { BundleSelectorEnhancer } = await import("./index-BghLoiUB.js");
          return new BundleSelectorEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-DyjgXyJw.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./index-C2GvfW3O.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./index-EJHXTem_.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./index-BQKe6k3c.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-D_uVV6kZ.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-9TMP2nh9.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-Ctz50k1a.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-BvM45yy5.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-CvVdnYFK.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async captureUrlParameters(urlParams) {
    try {
      const { useParameterStore: useParameterStore2 } = await import("./stores-DhBPTw5A.js").then((n) => n.p);
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-JP7GtpcB.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-JP7GtpcB.js").then((n) => n.y).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./debug-DFHmnLQ4.js").then((n) => n.D);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./debug-DFHmnLQ4.js").then((n) => n.D).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./index-lV2ZpjcR.js");
        import("./index-CSyzn4jB.js");
        import("./index-BWMwS6MD.js");
        import("./ProductDisplayEnhancer-DIte8ZLu.js");
        import("./SelectionDisplayEnhancer-ClSbVc7z.js");
        import("./TimerEnhancer-7-UNxZqE.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-CGVoVPQ8.js");
        import("./ExpressCheckoutContainerEnhancer-DmlNX_jt.js");
        import("./OrderDisplayEnhancer-W_fZP4ef.js");
        import("./index-BQKe6k3c.js");
        import("./utils-JP7GtpcB.js").then((n) => n.A);
        import("./index-BYOcA8vv.js");
        import("./index-C2GvfW3O.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-9TMP2nh9.js");
        import("./CouponEnhancer-D_uVV6kZ.js");
        import("./SimpleExitIntentEnhancer-BPnWvl-H.js");
      }, { timeout: 5e3 });
    } else {
      setTimeout(() => {
        import("./index-lV2ZpjcR.js");
        import("./ProductDisplayEnhancer-DIte8ZLu.js");
        import("./utils-JP7GtpcB.js").then((n) => n.z);
      }, 1e3);
    }
  });
}
