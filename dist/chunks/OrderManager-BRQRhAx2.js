import { n as nextAnalytics, E as EcommerceEvents, u as useCampaignStore, c as configStore, d as useAttributionStore, a as useCartStore, b as useCheckoutStore } from "./analytics-hnrlm383.js";
import { x as getFailureUrl, y as getSuccessUrl, z as handleOrderRedirect } from "./utils-COqAt8L9.js";
...
class OrderManager {
  ...
  async createExpressOrder(cartItems, paymentMethod) {
    ...
    try {
      ...
      const { useCheckoutStore: useCheckoutStore2 } = await import("./analytics-hnrlm383.js").then((n) => n.g);
