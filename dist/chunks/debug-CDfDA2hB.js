import { c as createLogger, L as Logger, b as CountryService, E as EventBus, f as formatCurrency } from "./utils-DTwlwnMm.js";
import { c as configStore, u as useCampaignStore, a as useCartStore, b as useCheckoutStore } from "./analytics-Ci0jTs8y.js";
...
class LocaleSelector {
  ...
  async handleLocaleChange(newLocale, isReset = false) {
    ...
    try {
      ...
      const { CurrencyFormatter } = await import("./utils-DTwlwnMm.js").then((n) => n.B);
      CurrencyFormatter.clearCache();
      const { useCartStore: useCartStore2 } = await import("./analytics-Ci0jTs8y.js").then((n) => n.i);
