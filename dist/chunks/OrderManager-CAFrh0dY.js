import { n as nextAnalytics, E as EcommerceEvents } from "./analytics-CmxZVjYV.js";
import { q as getFailureUrl, s as getSuccessUrl, t as handleOrderRedirect } from "./utils-B1R7dAlO.js";
import { d as useCampaignStore, a as configStore, u as useAttributionStore, e as useCartStore, b as useCheckoutStore } from "./stores-Cc3b6sAD.js";
...
class OrderManager {
  ...
  async createExpressOrder(cartItems, paymentMethod) {
    ...
    try {
      ...
      const { useCheckoutStore: useCheckoutStore2 } = await import("./stores-Cc3b6sAD.js").then((n) => n.k);
