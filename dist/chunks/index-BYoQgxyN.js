import { L as Logger, E as EventBus, u as useCampaignStore, a as configStore, d as useProfileStore, e as useParameterStore, c as createLogger, b as CART_STORAGE_KEY, C as CountryService, g as LogLevel } from "./utils-KyZ-kCkO.js";
import { u as useCartStore, b as useAttributionStore, a as useCheckoutStore } from "./analytics-BpHbNJV1.js";
import { u as useOrderStore, t as testModeManager } from "./debug-BoMJ3ZaG.js";
import { ApiClient } from "./api-PHBYxBTi.js";
class NextCommerce {
  constructor() {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-BpHbNJV1.js").then((n) => n.e);
  ...
  async trackViewItem(packageId) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-BpHbNJV1.js").then((n) => n.e);
        const { useCampaignStore: useCampaignStore2 } = await import("./utils-KyZ-kCkO.js").then((n) => n.B);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./analytics-BpHbNJV1.js").then((n) => n.e);
        nextAnalytics.track(
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-mN7fk3Dv.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-Cs3Vtyst.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-DZ5LMlCM.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-DkAbfep2.js");
        ...
        case "package-toggle":
          const { PackageToggleEnhancer } = await import("./index-CmAtxw_r.js");
          return new PackageToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./AddToCartEnhancer-BjnSFnpN.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-Blkk8Cnk.js");
        ...
        case "package-selector":
          const { PackageSelectorEnhancer } = await import("./index-8UrGe2Hh.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-VdrYPzeO.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-0gFjGseA.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-D-HUxAtR.js");
        ...
        case "checkout-review":
          ...
          const { CheckoutReviewEnhancer } = await import("./CheckoutReviewEnhancer-khtzpqr5.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-BFjcRAXP.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-CFvI9mF2.js");
          return new CartItemListEnhancer(element);
        case "cart-summary":
          const { CartSummaryEnhancer } = await import("./index-CWt27cgO.js");
          return new CartSummaryEnhancer(element);
        case "bundle-selector":
          const { BundleSelectorEnhancer } = await import("./index-Boyy8Soj.js");
          return new BundleSelectorEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-DQoU69BO.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-DUoUhsdL.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-DbTXHYT1.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-BfnlqWZa.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-zV-Euuot.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-Cqent_i1.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-C8il_T1Y.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async captureUrlParameters(urlParams) {
    try {
      const { useParameterStore: useParameterStore2 } = await import("./utils-KyZ-kCkO.js").then((n) => n.I);
  ...
  static async processProfileParameter() {
    ...
    if (configStore$1.profiles && Object.keys(configStore$1.profiles).length > 0) {
      const { useProfileStore: useProfileStore22 } = await import("./utils-KyZ-kCkO.js").then((n) => n.G);
    ...
    const { useProfileStore: useProfileStore2 } = await import("./utils-KyZ-kCkO.js").then((n) => n.G);
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-KyZ-kCkO.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-KyZ-kCkO.js").then((n) => n.N).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./debug-BoMJ3ZaG.js").then((n) => n.D);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./debug-BoMJ3ZaG.js").then((n) => n.D).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-DZ5LMlCM.js");
        import("./index-CmAtxw_r.js");
        import("./index-8UrGe2Hh.js");
        import("./ProductDisplayEnhancer-OSPNwov8.js");
        import("./SelectionDisplayEnhancer-DkAbfep2.js");
        import("./TimerEnhancer-VdrYPzeO.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-D-HUxAtR.js");
        import("./ExpressCheckoutContainerEnhancer-BFjcRAXP.js");
        import("./OrderDisplayEnhancer-B7HAn5zl.js");
        import("./UpsellEnhancer-DUoUhsdL.js");
        import("./utils-KyZ-kCkO.js").then((n) => n.M);
        import("./CartItemListEnhancer-CFvI9mF2.js");
        import("./QuantityControlEnhancer-CbjkvvIK.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-BfnlqWZa.js");
        import("./CouponEnhancer-DbTXHYT1.js");
        import("./SimpleExitIntentEnhancer-mN7fk3Dv.js");
      ...
      setTimeout(() => {
        import("./CartDisplayEnhancer-DZ5LMlCM.js");
        import("./ProductDisplayEnhancer-OSPNwov8.js");
        import("./utils-KyZ-kCkO.js").then((n) => n.O);
      }, 1e3);
    }
  });
}
