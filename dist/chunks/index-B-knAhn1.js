import { L as Logger, E as EventBus, c as createLogger, a as LogLevel } from "./analytics-DdhZlX6_.js";
import { ApiClient } from "./api-CaYbbYDR.js";
import { e as cartOperations, d as useCartStore, a as useCampaignStore, b as useAttributionStore, u as useCheckoutStore, f as useOrderStore, c as configStore, g as useParameterStore, C as CART_STORAGE_KEY } from "./state-pM9xfsfc.js";
...
class NextCommerce {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-DdhZlX6_.js").then((n) => n.i);
  ...
  async trackViewItem(packageId) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-DdhZlX6_.js").then((n) => n.i);
        const { useCampaignStore: useCampaignStore2 } = await import("./state-pM9xfsfc.js").then((n) => n.j);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./analytics-DdhZlX6_.js").then((n) => n.i);
        nextAnalytics.track(
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./index-CrG9WCnY.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./index-BQN-yIfn.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart" || parsed.object === "cart-summary") {
            ...
            const { CartDisplayEnhancer } = await import("./index-BmO7pGxb.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./index-BGmzkR5d.js");
            ...
            const { PackageSelectorDisplayEnhancer } = await import("./index-BMDKHx_5.js");
            ...
            const { PackageToggleDisplayEnhancer } = await import("./index-Gi6t3j25.js");
        ...
        case "package-toggle":
          const { PackageToggleEnhancer } = await import("./index-Gi6t3j25.js");
          return new PackageToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./index-Cn7zRx2X.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./index-_yyjIQFI.js");
        ...
        case "package-selector":
          const { PackageSelectorEnhancer } = await import("./index-BMDKHx_5.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./index-DfgjAQid.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./index-CZgyOb8y.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./checkout-form.enhancer-ZA4pavq6.js");
        ...
        case "checkout-review":
          ...
          const { CheckoutReviewEnhancer } = await import("./checkout-review.enhancer-eiMQbG-K.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./express-checkout-container.enhancer-BNOWwBI5.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./index-ClP83hAT.js");
          return new CartItemListEnhancer(element);
        case "cart-summary":
          const { CartSummaryEnhancer } = await import("./index-BmO7pGxb.js");
          return new CartSummaryEnhancer(element);
        case "bundle-selector":
          const { BundleSelectorEnhancer } = await import("./index-DRQGTasC.js");
          return new BundleSelectorEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./index-Cia1RVtP.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./index-_a7FEiwz.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./index-ZktnRpQa.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./index-aW-A5O1q.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./index-B205ZRDz.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./index-BZuOElK0.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./index-COOtj5HS.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./index-BGHRln4u.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./index-CCArrfwv.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async captureUrlParameters(urlParams) {
    try {
      const { useParameterStore: useParameterStore2 } = await import("./state-pM9xfsfc.js").then((n) => n.m);
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utm-transfer-qU5AQCJR.js");
  ...
  static initializeErrorHandler() {
    try {
      import("./error-handler-HbuLRk63.js").then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./debug-DwIz_ASh.js").then((n) => n.D);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./debug-DwIz_ASh.js").then((n) => n.D).then((m) => m.debugOverlay),
...
const VERSION = typeof window !== "undefined" && window.__NEXT_SDK_VERSION__ ? window.__NEXT_SDK_VERSION__ : "0.4.31";
if (typeof window !== "undefined") {
  if (document.readyState === "loading") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./index-BmO7pGxb.js");
        import("./index-Gi6t3j25.js");
        import("./index-BMDKHx_5.js");
        import("./index-C7Yqdql9.js");
        import("./index-BGmzkR5d.js");
        import("./index-DfgjAQid.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./checkout-form.enhancer-ZA4pavq6.js");
        import("./express-checkout-container.enhancer-BNOWwBI5.js");
        import("./index-cHDiXkbG.js");
        import("./index-aW-A5O1q.js");
        import("./attribution-collector-CKepBwFI.js");
        import("./index-ClP83hAT.js");
        import("./index-_a7FEiwz.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./index-BZuOElK0.js");
        import("./index-B205ZRDz.js");
        import("./index-CrG9WCnY.js");
      }, { timeout: 5e3 });
    } else {
      setTimeout(() => {
        import("./index-BmO7pGxb.js");
        import("./index-C7Yqdql9.js");
        import("./analytics-DdhZlX6_.js").then((n) => n.i);
      }, 1e3);
    }
  });
}
