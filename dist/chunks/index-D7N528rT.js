import { a as useCartStore, u as useCampaignStore, e as useAttributionStore, b as useCheckoutStore, c as configStore, d as useProfileStore } from "./analytics-C593VfhV.js";
import { u as useOrderStore, t as testModeManager } from "./debug-DXDufq0V.js";
import { L as Logger, E as EventBus, u as useParameterStore, c as createLogger, b as CountryService, C as CART_STORAGE_KEY, d as LogLevel } from "./utils-CJHo6zrd.js";
...
class NextCommerce {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-C593VfhV.js").then((n) => n.k);
  ...
  async trackViewItem(packageId) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-C593VfhV.js").then((n) => n.k);
        const { useCampaignStore: useCampaignStore2 } = await import("./analytics-C593VfhV.js").then((n) => n.g);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./analytics-C593VfhV.js").then((n) => n.k);
        nextAnalytics.track(
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-eFFIYkib.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-DGGq1HAg.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-69C1Zghf.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-E89pmKLB.js");
            ...
            const { PackageSelectorDisplayEnhancer } = await import("./index-chakB4NP.js");
            ...
            const { PackageToggleDisplayEnhancer } = await import("./index-CQ5xg-gt.js");
        ...
        case "package-toggle":
          const { PackageToggleEnhancer } = await import("./index-CQ5xg-gt.js");
          return new PackageToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./index-DkPwy-hd.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./index-PdkEVWjb.js");
        ...
        case "package-selector":
          const { PackageSelectorEnhancer } = await import("./index-chakB4NP.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-Dsllzh2r.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-CgbmKBaa.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-4Jki1uTf.js");
        ...
        case "checkout-review":
          ...
          const { CheckoutReviewEnhancer } = await import("./CheckoutReviewEnhancer-DQaSFJm6.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-BMk-uJau.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./index-CDePrfWC.js");
          return new CartItemListEnhancer(element);
        case "cart-summary":
          const { CartSummaryEnhancer } = await import("./index-CAVsH7zR.js");
          return new CartSummaryEnhancer(element);
        case "bundle-selector":
          const { BundleSelectorEnhancer } = await import("./index-ZphRlSqL.js");
          return new BundleSelectorEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-USSbDWcl.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./index-B5l3Zz80.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./index-CAHUBOT5.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./index-a2kyMZ3r.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-OzlOhpvC.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-DSRlYDAs.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-DxsEW3N4.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-C8U32EEg.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-EvLse7Kd.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async captureUrlParameters(urlParams) {
    try {
      const { useParameterStore: useParameterStore2 } = await import("./utils-CJHo6zrd.js").then((n) => n.A);
  ...
  static async processProfileParameter() {
    ...
    if (configStore$1.profiles && Object.keys(configStore$1.profiles).length > 0) {
      const { useProfileStore: useProfileStore22 } = await import("./analytics-C593VfhV.js").then((n) => n.p);
    ...
    const { useProfileStore: useProfileStore2 } = await import("./analytics-C593VfhV.js").then((n) => n.p);
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-CJHo6zrd.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-CJHo6zrd.js").then((n) => n.I).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./debug-DXDufq0V.js").then((n) => n.D);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./debug-DXDufq0V.js").then((n) => n.D).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-69C1Zghf.js");
        import("./index-CQ5xg-gt.js");
        import("./index-chakB4NP.js");
        import("./ProductDisplayEnhancer-BXBx5qdD.js");
        import("./SelectionDisplayEnhancer-E89pmKLB.js");
        import("./TimerEnhancer-Dsllzh2r.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-4Jki1uTf.js");
        import("./ExpressCheckoutContainerEnhancer-BMk-uJau.js");
        import("./OrderDisplayEnhancer-Du-Dy17k.js");
        import("./index-a2kyMZ3r.js");
        import("./utils-CJHo6zrd.js").then((n) => n.G);
        import("./index-CDePrfWC.js");
        import("./index-B5l3Zz80.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-DSRlYDAs.js");
        import("./CouponEnhancer-OzlOhpvC.js");
        import("./SimpleExitIntentEnhancer-eFFIYkib.js");
      ...
      setTimeout(() => {
        import("./CartDisplayEnhancer-69C1Zghf.js");
        import("./ProductDisplayEnhancer-BXBx5qdD.js");
        import("./utils-CJHo6zrd.js").then((n) => n.J);
      }, 1e3);
    }
  });
}
