import { n as nextAnalytics, E as EcommerceEvents, u as useCampaignStore, c as configStore, d as useAttributionStore, a as useCartStore, b as useCheckoutStore } from "./analytics-Ci0jTs8y.js";
import { q as getFailureUrl, r as getSuccessUrl, t as handleOrderRedirect } from "./utils-DTwlwnMm.js";
...
class OrderManager {
  ...
  async createExpressOrder(cartItems, paymentMethod) {
    ...
    try {
      ...
      const { useCheckoutStore: useCheckoutStore2 } = await import("./analytics-Ci0jTs8y.js").then((n) => n.g);
