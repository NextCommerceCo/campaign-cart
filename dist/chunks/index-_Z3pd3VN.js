import { a as useCartStore, u as useCampaignStore, d as useAttributionStore, c as configStore, b as useProfileStore } from "./analytics-HEjue3qx.js";
import { u as useCheckoutStore, a as useOrderStore, t as testModeManager } from "./debug-2JhZjhRv.js";
import { c as create, p as persist } from "./vendor-DmEBrpID.js";
import { c as createLogger, L as Logger, E as EventBus, d as CountryService, a as CART_STORAGE_KEY, e as LogLevel } from "./utils-BRNcNidD.js";
import { ApiClient } from "./api-C3PBopKm.js";
...
class NextCommerce {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-HEjue3qx.js").then((n) => n.i);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./analytics-HEjue3qx.js").then((n) => n.i);
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-CXYLNK70.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-nAW4DCrg.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-H9bLvslq.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-By4RkOev.js");
        ...
        case "toggle":
          const { CartToggleEnhancer } = await import("./CartToggleEnhancer-ZEZvlRCR.js");
          return new CartToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./AddToCartEnhancer-B5fYg0Ee.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-C2kPnAh_.js");
        ...
        case "selector":
          const { PackageSelectorEnhancer } = await import("./PackageSelectorEnhancer-DPHhp9ox.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-C_VcKfKb.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-pMxt2CYs.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-qgVuZ1Tn.js");
        ...
        case "checkout-review":
          ...
          const { CheckoutReviewEnhancer } = await import("./CheckoutReviewEnhancer-CTY9joGZ.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-5AzwVvuk.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-CEr2sD8R.js");
          return new CartItemListEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-DNln2man.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./QuantityControlEnhancer-K6_55NOV.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./RemoveItemEnhancer-BaVC-0aK.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-eFVDd35Z.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-DNTTQ6Yi.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-Bov0Rz9y.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-BQ_M99o7.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-GiYkjqnS.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-CW1etAvg.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async processProfileParameter() {
    ...
    if (configStore$1.profiles && Object.keys(configStore$1.profiles).length > 0) {
      const { useProfileStore: useProfileStore22 } = await import("./analytics-HEjue3qx.js").then((n) => n.p);
    ...
    const { useProfileStore: useProfileStore2 } = await import("./analytics-HEjue3qx.js").then((n) => n.p);
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-BRNcNidD.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-BRNcNidD.js").then((n) => n.z).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./debug-2JhZjhRv.js").then((n) => n.D);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./debug-2JhZjhRv.js").then((n) => n.D).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-H9bLvslq.js");
        import("./CartToggleEnhancer-ZEZvlRCR.js");
        import("./PackageSelectorEnhancer-DPHhp9ox.js");
        import("./ProductDisplayEnhancer-UqUQjiV4.js");
        import("./SelectionDisplayEnhancer-By4RkOev.js");
        import("./TimerEnhancer-C_VcKfKb.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-qgVuZ1Tn.js");
        import("./ExpressCheckoutContainerEnhancer-5AzwVvuk.js");
        import("./OrderDisplayEnhancer-Cu6y3zWY.js");
        import("./UpsellEnhancer-eFVDd35Z.js");
        import("./utils-BRNcNidD.js").then((n) => n.A);
        import("./CartItemListEnhancer-CEr2sD8R.js");
        import("./QuantityControlEnhancer-K6_55NOV.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-Bov0Rz9y.js");
        import("./CouponEnhancer-DNTTQ6Yi.js");
        import("./SimpleExitIntentEnhancer-CXYLNK70.js");
      ...
      setTimeout(() => {
        import("./CartDisplayEnhancer-H9bLvslq.js");
        import("./ProductDisplayEnhancer-UqUQjiV4.js");
        import("./utils-BRNcNidD.js").then((n) => n.B);
      }, 1e3);
    }
  });
}
