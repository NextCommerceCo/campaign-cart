import { c as createLogger, L as Logger, a as configStore, u as useCampaignStore, C as CountryService, E as EventBus, f as formatCurrency } from "./utils-KyZ-kCkO.js";
import { u as useCartStore, a as useCheckoutStore } from "./analytics-BpHbNJV1.js";
...
class LocaleSelector {
  ...
  async handleLocaleChange(newLocale, isReset = false) {
    ...
    try {
      ...
      const { CurrencyFormatter } = await import("./utils-KyZ-kCkO.js").then((n) => n.J);
      CurrencyFormatter.clearCache();
      const { useCartStore: useCartStore2 } = await import("./analytics-BpHbNJV1.js").then((n) => n.i);
