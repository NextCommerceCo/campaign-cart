...
import { a as useCheckoutStore, u as useCartStore } from "./analytics-BpHbNJV1.js";
...
async function fetchAndUpdatePrice(item, includeShipping, logger) {
  ...
  try {
    ...
    const effectiveTotals = retailCompareTotal > 0 ? buildCartTotals(summary, { exclude_shipping: !includeShipping, compareTotal: retailCompareTotal }) : totals;
