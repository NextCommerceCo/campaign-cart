import { L as Logger, a as configStore, d as useCampaignStore, e as useCartStore, E as EventBus, f as useOrderStore, b as useCheckoutStore } from "./stores-T9INJ71u.js";
import { C as CountryService, f as formatCurrency } from "./utils-C4PNEPcs.js";
import { H as HighlightJS, j as json } from "./vendor-Dh2qjXKZ.js";
...
class LocaleSelector {
  ...
  async handleLocaleChange(newLocale, isReset = false) {
    ...
    try {
      ...
      const { CurrencyFormatter } = await import("./utils-C4PNEPcs.js").then((n) => n.x);
      CurrencyFormatter.clearCache();
      const { useCartStore: useCartStore2 } = await import("./stores-T9INJ71u.js").then((n) => n.i);
