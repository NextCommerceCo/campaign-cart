import { a as useCartStore, u as useCampaignStore, e as useAttributionStore, b as useCheckoutStore, c as configStore, d as useProfileStore } from "./analytics-Cw4L66g8.js";
import { u as useOrderStore, t as testModeManager } from "./debug-lQ_yCXwL.js";
import { L as Logger, E as EventBus, u as useParameterStore, c as createLogger, d as CountryService, a as CART_STORAGE_KEY, e as LogLevel } from "./utils-BYdmVAcS.js";
import { ApiClient } from "./api-5dYcqF6q.js";
class NextCommerce {
  constructor() {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-Cw4L66g8.js").then((n) => n.i);
  ...
  async trackViewItem(packageId) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-Cw4L66g8.js").then((n) => n.i);
        const { useCampaignStore: useCampaignStore2 } = await import("./analytics-Cw4L66g8.js").then((n) => n.g);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./analytics-Cw4L66g8.js").then((n) => n.i);
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-C1KqJk-V.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-B90DsBcq.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-B-O3qDeB.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-qKbutoha.js");
        ...
        case "toggle":
          const { CartToggleEnhancer } = await import("./CartToggleEnhancer-BJNdkOYQ.js");
          return new CartToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./AddToCartEnhancer-BzD-AnOQ.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-tAuPJsGs.js");
        ...
        case "selector":
          const { PackageSelectorEnhancer } = await import("./PackageSelectorEnhancer-DKR1AUHo.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-6yytQt5A.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-ZObPbhZg.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-Cp6D0uud.js");
        ...
        case "checkout-review":
          ...
          const { CheckoutReviewEnhancer } = await import("./CheckoutReviewEnhancer-BpOa7iEO.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-JnB2Urpa.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-B79OFojt.js");
          return new CartItemListEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-Dh7lwXpI.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./QuantityControlEnhancer-D1IjP0KQ.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./RemoveItemEnhancer--ANPvgGU.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-r0PW2OwG.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-nrzOc9I7.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-CKeWNRv6.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-CkI3ApBB.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-OPgiVWwb.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-C1CeoPfV.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async captureUrlParameters(urlParams) {
    try {
      const { useParameterStore: useParameterStore2 } = await import("./utils-BYdmVAcS.js").then((n) => n.A);
  ...
  static async processProfileParameter() {
    ...
    if (configStore$1.profiles && Object.keys(configStore$1.profiles).length > 0) {
      const { useProfileStore: useProfileStore22 } = await import("./analytics-Cw4L66g8.js").then((n) => n.p);
    ...
    const { useProfileStore: useProfileStore2 } = await import("./analytics-Cw4L66g8.js").then((n) => n.p);
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-BYdmVAcS.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-BYdmVAcS.js").then((n) => n.G).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./debug-lQ_yCXwL.js").then((n) => n.D);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./debug-lQ_yCXwL.js").then((n) => n.D).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-B-O3qDeB.js");
        import("./CartToggleEnhancer-BJNdkOYQ.js");
        import("./PackageSelectorEnhancer-DKR1AUHo.js");
        import("./ProductDisplayEnhancer-CzVZiXfM.js");
        import("./SelectionDisplayEnhancer-qKbutoha.js");
        import("./TimerEnhancer-6yytQt5A.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-Cp6D0uud.js");
        import("./ExpressCheckoutContainerEnhancer-JnB2Urpa.js");
        import("./OrderDisplayEnhancer-BcKe46o4.js");
        import("./UpsellEnhancer-r0PW2OwG.js");
        import("./utils-BYdmVAcS.js").then((n) => n.B);
        import("./CartItemListEnhancer-B79OFojt.js");
        import("./QuantityControlEnhancer-D1IjP0KQ.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-CKeWNRv6.js");
        import("./CouponEnhancer-nrzOc9I7.js");
        import("./SimpleExitIntentEnhancer-C1KqJk-V.js");
      ...
      setTimeout(() => {
        import("./CartDisplayEnhancer-B-O3qDeB.js");
        import("./ProductDisplayEnhancer-CzVZiXfM.js");
        import("./utils-BYdmVAcS.js").then((n) => n.H);
      }, 1e3);
    }
  });
}
