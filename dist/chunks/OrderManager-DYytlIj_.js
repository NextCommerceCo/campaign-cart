import { n as nextAnalytics, E as EcommerceEvents, u as useCampaignStore, c as configStore, d as useAttributionStore, a as useCartStore, b as useCheckoutStore } from "./analytics-BHJjHc1E.js";
import { v as getFailureUrl, w as getSuccessUrl, x as handleOrderRedirect } from "./utils-R5pRn2AT.js";
...
class OrderManager {
  ...
  async createExpressOrder(cartItems, paymentMethod) {
    ...
    try {
      ...
      const { useCheckoutStore: useCheckoutStore2 } = await import("./analytics-BHJjHc1E.js").then((n) => n.g);
