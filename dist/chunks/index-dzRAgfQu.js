...
import { u as useOrderStore, t as testModeManager } from "./debug-Co30NKLn.js";
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart" || parsed.object === "cart-summary") {
            ...
            const { CartDisplayEnhancer } = await import("./index-UyTpnOiS.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-0BTHdSGW.js");
            ...
            const { PackageSelectorDisplayEnhancer } = await import("./index-22V2zP2F.js");
            ...
            const { PackageToggleDisplayEnhancer } = await import("./index-CICo3VnF.js");
        ...
        case "package-toggle":
          const { PackageToggleEnhancer } = await import("./index-CICo3VnF.js");
        ...
        case "action":
          ...
          switch (action) {
            ...
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./index-SZJA4TTQ.js");
        ...
        case "package-selector":
          const { PackageSelectorEnhancer } = await import("./index-22V2zP2F.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-Cd_qvWMH.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./index-DWnuPikq.js");
          return new CartItemListEnhancer(element);
        case "cart-summary":
          const { CartSummaryEnhancer } = await import("./index-UyTpnOiS.js");
          return new CartSummaryEnhancer(element);
        case "bundle-selector":
          const { BundleSelectorEnhancer } = await import("./index-Cb1z5Bze.js");
          return new BundleSelectorEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-BKNgu1s2.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./index-DaSmpzf1.js");
        ...
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-nVSHIVBx.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./debug-Co30NKLn.js").then((n) => n.D);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./debug-Co30NKLn.js").then((n) => n.D).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./index-UyTpnOiS.js");
        import("./index-CICo3VnF.js");
        import("./index-22V2zP2F.js");
        import("./ProductDisplayEnhancer-jXeP7sA9.js");
        import("./SelectionDisplayEnhancer-0BTHdSGW.js");
      ...
      requestIdleCallback(() => {
        ...
        import("./OrderDisplayEnhancer-Bxgj1LzL.js");
        import("./index-DaSmpzf1.js");
        import("./utils-CMIpev9P.js").then((n) => n.B);
        import("./index-DWnuPikq.js");
