import { L as Logger, E as EventBus, e as useCartStore, d as useCampaignStore, u as useAttributionStore, b as useCheckoutStore, f as useOrderStore, a as configStore, g as useParameterStore, c as createLogger, C as CART_STORAGE_KEY, h as LogLevel } from "./stores-Cc3b6sAD.js";
import { ApiClient } from "./api-DUevBnpU.js";
import { t as testModeManager } from "./debug-DaOTdf4f.js";
import { C as CountryService } from "./utils-B1R7dAlO.js";
class NextCommerce {
  constructor() {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-CmxZVjYV.js").then((n) => n.i);
  ...
  async trackViewItem(packageId) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-CmxZVjYV.js").then((n) => n.i);
        const { useCampaignStore: useCampaignStore2 } = await import("./stores-Cc3b6sAD.js").then((n) => n.j);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./analytics-CmxZVjYV.js").then((n) => n.i);
        nextAnalytics.track(
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-B4-gXLCY.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-sGxNX0Xi.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart" || parsed.object === "cart-summary") {
            ...
            const { CartDisplayEnhancer } = await import("./index-hwvGshoC.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-BG27TyEX.js");
            ...
            const { PackageSelectorDisplayEnhancer } = await import("./index-B2qKIXeT.js");
            ...
            const { PackageToggleDisplayEnhancer } = await import("./index-Be3PPLyv.js");
        ...
        case "package-toggle":
          const { PackageToggleEnhancer } = await import("./index-Be3PPLyv.js");
          return new PackageToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./index-BmXMtY8C.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./index-0jz21AzU.js");
        ...
        case "package-selector":
          const { PackageSelectorEnhancer } = await import("./index-B2qKIXeT.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-DqRH05tB.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-Bboyk8ZY.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-C5hrKTOS.js");
        ...
        case "checkout-review":
          ...
          const { CheckoutReviewEnhancer } = await import("./CheckoutReviewEnhancer-BPb3ZJGF.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-zHKBRIGf.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./index-0zTPvNAI.js");
          return new CartItemListEnhancer(element);
        case "cart-summary":
          const { CartSummaryEnhancer } = await import("./index-hwvGshoC.js");
          return new CartSummaryEnhancer(element);
        case "bundle-selector":
          const { BundleSelectorEnhancer } = await import("./index-6HMTf0Mg.js");
          return new BundleSelectorEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-CH6hxzVL.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./index-BxfNwYsx.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./index-Bq_xvyjQ.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./index-BmExS2FJ.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-Dt-4ZuCO.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-vBpbZN7V.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-hY4HcfCw.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-CJGAj49w.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-zhHEr7aa.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async captureUrlParameters(urlParams) {
    try {
      const { useParameterStore: useParameterStore2 } = await import("./stores-Cc3b6sAD.js").then((n) => n.p);
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-B1R7dAlO.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-B1R7dAlO.js").then((n) => n.y).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./debug-DaOTdf4f.js").then((n) => n.D);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./debug-DaOTdf4f.js").then((n) => n.D).then((m) => m.debugOverlay),
...
const VERSION = typeof window !== "undefined" && window.__NEXT_SDK_VERSION__ ? window.__NEXT_SDK_VERSION__ : "0.4.28";
if (typeof window !== "undefined") {
  if (document.readyState === "loading") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./index-hwvGshoC.js");
        import("./index-Be3PPLyv.js");
        import("./index-B2qKIXeT.js");
        import("./ProductDisplayEnhancer-DEK0wb-V.js");
        import("./SelectionDisplayEnhancer-BG27TyEX.js");
        import("./TimerEnhancer-DqRH05tB.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-C5hrKTOS.js");
        import("./ExpressCheckoutContainerEnhancer-zHKBRIGf.js");
        import("./OrderDisplayEnhancer-BeeOm8Tq.js");
        import("./index-BmExS2FJ.js");
        import("./utils-B1R7dAlO.js").then((n) => n.A);
        import("./index-0zTPvNAI.js");
        import("./index-BxfNwYsx.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-vBpbZN7V.js");
        import("./CouponEnhancer-Dt-4ZuCO.js");
        import("./SimpleExitIntentEnhancer-B4-gXLCY.js");
      }, { timeout: 5e3 });
    } else {
      setTimeout(() => {
        import("./index-hwvGshoC.js");
        import("./ProductDisplayEnhancer-DEK0wb-V.js");
        import("./utils-B1R7dAlO.js").then((n) => n.z);
      }, 1e3);
    }
  });
}
