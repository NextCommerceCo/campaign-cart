import { c as createLogger, L as Logger, d as CountryService, E as EventBus } from "./utils-C0UWTkxd.js";
...
class LocaleSelector {
  ...
  async handleLocaleChange(newLocale, isReset = false) {
    ...
    try {
      ...
      const { CurrencyFormatter } = await import("./utils-C0UWTkxd.js").then((n) => n.z);
      CurrencyFormatter.clearCache();
      const { useCartStore: useCartStore2 } = await import("./analytics-C_Fzo5bG.js").then((n) => n.h);
