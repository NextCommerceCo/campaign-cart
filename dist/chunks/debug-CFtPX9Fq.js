import { L as Logger, E as EventBus, r as reconcileValue } from "./analytics-rw-aPuCY.js";
import { c as configStore, a as useCampaignStore, e as cartOperations, d as useCartStore, f as useOrderStore, u as useCheckoutStore } from "./state-Cak3W8JX.js";
import { f as formatCurrency } from "./utils-w-A9JGvN.js";
...
class LocaleSelector {
  ...
  async handleLocaleChange(newLocale, isReset = false) {
    ...
    try {
      ...
      const { CurrencyFormatter } = await import("./utils-w-A9JGvN.js").then((n) => n.u);
      CurrencyFormatter.clearCache();
      const { cartOperations: cartOperations2 } = await import("./state-Cak3W8JX.js").then((n) => n.i);
