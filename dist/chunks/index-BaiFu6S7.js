...
import { f as formatCurrency, b as formatPercentage, c as formatDiscountPercentage } from "./debug-DwIz_ASh.js";
import { A as AttributeParser } from "./index-B8ESOr6H.js";
import { r as renderDiscountContainers, a as renderFlatDiscountContainers, b as replaceVarsPreservingTemplates } from "./discount-renderer-CezMxLSo.js";
import { d as useCartStore, a as useCampaignStore, c as configStore } from "./state-pM9xfsfc.js";
...
function buildLineElement(template, line, warn) {
  ...
  const propertiesContainer = el.querySelector("[data-next-item-properties]");
  if (propertiesContainer) {
    const propTemplate = propertiesContainer.querySelector(":scope > template");
    if (propTemplate) {
      ...
      for (const [key, value] of entries) {
        const html = tmpl.replace(/\{property\.key\}/g, escapeHtml(key)).replace(/\{property\.value\}/g, escapeHtml(value));
