import { n as nextAnalytics, E as EcommerceEvents } from "./analytics-Buzgs8AR.js";
import { q as getFailureUrl, s as getSuccessUrl, t as handleOrderRedirect } from "./utils-D0Guuvf0.js";
import { b as useCampaignStore, a as configStore, u as useAttributionStore, e as useCartStore, d as useCheckoutStore } from "./stores-CgBkvYdT.js";
...
class OrderManager {
  ...
  async createExpressOrder(cartItems, paymentMethod) {
    ...
    try {
      ...
      const { useCheckoutStore: useCheckoutStore2 } = await import("./stores-CgBkvYdT.js").then((n) => n.k);
