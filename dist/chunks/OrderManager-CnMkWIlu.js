import { n as nextAnalytics, E as EcommerceEvents, b as useAttributionStore, u as useCartStore, a as useCheckoutStore } from "./analytics-BpHbNJV1.js";
import { u as useCampaignStore, a as configStore, v as getFailureUrl, w as getSuccessUrl, x as handleOrderRedirect } from "./utils-KyZ-kCkO.js";
...
class OrderManager {
  ...
  async createExpressOrder(cartItems, paymentMethod) {
    ...
    try {
      ...
      const { useCheckoutStore: useCheckoutStore2 } = await import("./analytics-BpHbNJV1.js").then((n) => n.d);
