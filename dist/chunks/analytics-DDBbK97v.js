import { D as Decimal, c as create, p as persist, s as subscribeWithSelector } from "./vendor-DBG5xMk9.js";
import { E as EventBus, c as createLogger, a as CART_STORAGE_KEY, s as sessionStorageManager, b as CAMPAIGN_STORAGE_KEY } from "./utils-D7bEf2-B.js";
  ...
  calculateTotals: () => {
    ...
    scheduleCalculate(async (signal) => {
      try {
        ...
        const { calculateCart } = await import("./utils-D7bEf2-B.js").then((n) => n.I);
    ...
    try {
      ...
      if (cachedData && cachedData.apiKey === apiKey && now - cachedData.timestamp < CACHE_EXPIRY_MS && (!isUrlCurrencyOverride || cachedData.campaign.currency === requestedCurrency)) {
        ...
        if (cachedCurrency !== requestedCurrency) {
          ...
          const { EventBus: EventBus2 } = await import("./utils-D7bEf2-B.js").then((n) => n.G);
      ...
      const { ApiClient } = await import("./api-Bq4JBUws.js");
...
const useAttributionStore = create()(
  persist(
    (set, get) => ({
      ...
      initialize: async () => {
        try {
          const { AttributionCollector } = await import("./utils-D7bEf2-B.js").then((n) => n.J);
