import { a as useCartStore, u as useCampaignStore, e as useAttributionStore, b as useCheckoutStore, c as configStore, d as useProfileStore } from "./analytics-DmiEcC3h.js";
import { u as useOrderStore, t as testModeManager } from "./debug-CAWPuTrP.js";
import { L as Logger, E as EventBus, u as useParameterStore, c as createLogger, d as CountryService, a as CART_STORAGE_KEY, e as LogLevel } from "./utils-C7C4iHfK.js";
import { ApiClient } from "./api-CYFaUSLx.js";
class NextCommerce {
  constructor() {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-DmiEcC3h.js").then((n) => n.i);
  ...
  async trackViewItem(packageId) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-DmiEcC3h.js").then((n) => n.i);
        const { useCampaignStore: useCampaignStore2 } = await import("./analytics-DmiEcC3h.js").then((n) => n.g);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./analytics-DmiEcC3h.js").then((n) => n.i);
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-BbDb0Rmx.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-DgyDTP25.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-CndF5twO.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-Dm1MPTjH.js");
        ...
        case "toggle":
          const { CartToggleEnhancer } = await import("./CartToggleEnhancer-eddaIcZs.js");
          return new CartToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./AddToCartEnhancer-CEDY9X3U.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-Cx3iM5LO.js");
        ...
        case "selector":
          const { PackageSelectorEnhancer } = await import("./PackageSelectorEnhancer-DRAe1Y-l.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-MhOLeImE.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-DKt0jpQH.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-BDVSVn0Y.js");
        ...
        case "checkout-review":
          ...
          const { CheckoutReviewEnhancer } = await import("./CheckoutReviewEnhancer-Cq3Hk0NG.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-DBcIQfYY.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-D9-BWUBa.js");
          return new CartItemListEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-CMAbTijh.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./QuantityControlEnhancer-C6gvgTsI.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./RemoveItemEnhancer-DKfScFDb.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-yWK3VfVA.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-DFSf48-u.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-CzToOXi4.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-fYgVtBDy.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-s0Z2ywBv.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-DFmVTj50.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async captureUrlParameters(urlParams) {
    try {
      const { useParameterStore: useParameterStore2 } = await import("./utils-C7C4iHfK.js").then((n) => n.A);
  ...
  static async processProfileParameter() {
    ...
    if (configStore$1.profiles && Object.keys(configStore$1.profiles).length > 0) {
      const { useProfileStore: useProfileStore22 } = await import("./analytics-DmiEcC3h.js").then((n) => n.p);
    ...
    const { useProfileStore: useProfileStore2 } = await import("./analytics-DmiEcC3h.js").then((n) => n.p);
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-C7C4iHfK.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-C7C4iHfK.js").then((n) => n.G).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./debug-CAWPuTrP.js").then((n) => n.D);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./debug-CAWPuTrP.js").then((n) => n.D).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-CndF5twO.js");
        import("./CartToggleEnhancer-eddaIcZs.js");
        import("./PackageSelectorEnhancer-DRAe1Y-l.js");
        import("./ProductDisplayEnhancer-61irM19m.js");
        import("./SelectionDisplayEnhancer-Dm1MPTjH.js");
        import("./TimerEnhancer-MhOLeImE.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-BDVSVn0Y.js");
        import("./ExpressCheckoutContainerEnhancer-DBcIQfYY.js");
        import("./OrderDisplayEnhancer-v4F92IzQ.js");
        import("./UpsellEnhancer-yWK3VfVA.js");
        import("./utils-C7C4iHfK.js").then((n) => n.B);
        import("./CartItemListEnhancer-D9-BWUBa.js");
        import("./QuantityControlEnhancer-C6gvgTsI.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-CzToOXi4.js");
        import("./CouponEnhancer-DFSf48-u.js");
        import("./SimpleExitIntentEnhancer-BbDb0Rmx.js");
      ...
      setTimeout(() => {
        import("./CartDisplayEnhancer-CndF5twO.js");
        import("./ProductDisplayEnhancer-61irM19m.js");
        import("./utils-C7C4iHfK.js").then((n) => n.H);
      }, 1e3);
    }
  });
}
