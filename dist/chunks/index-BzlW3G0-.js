  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-BWSARiGp.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-BkWwz3gq.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-CLnRSWRy.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-VvOas3G9.js");
        ...
        case "package-toggle":
          const { PackageToggleEnhancer } = await import("./index-C6wKvQD1.js");
          return new PackageToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./index-CRSbYkyG.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./index--o8vYIOY.js");
        ...
        case "package-selector":
          const { PackageSelectorEnhancer } = await import("./index-CC8ztvJY.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-COoIe53T.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-Cxw8G3VW.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-DJpwFbIy.js");
        ...
        case "checkout-review":
          ...
          const { CheckoutReviewEnhancer } = await import("./CheckoutReviewEnhancer-JEAkHdxN.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-CGcESZC3.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./index-C4G5cayo.js");
          return new CartItemListEnhancer(element);
        case "cart-summary":
          const { CartSummaryEnhancer } = await import("./index-DLGHWISQ.js");
          return new CartSummaryEnhancer(element);
        case "bundle-selector":
          const { BundleSelectorEnhancer } = await import("./index-dCik8oKP.js");
          return new BundleSelectorEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-Heh45oG4.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./index-BiuYmVkt.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./index-Bv1b7Q5Y.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./index-DRgVu42F.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-BgE2t_6N.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-BAmFKpw3.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-4v4zU1V2.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-CWokW5N0.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-BLqaWScv.js");
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-CLnRSWRy.js");
        import("./index-C6wKvQD1.js");
        import("./index-CC8ztvJY.js");
        import("./ProductDisplayEnhancer-CK7-WA0K.js");
        import("./SelectionDisplayEnhancer-VvOas3G9.js");
        import("./TimerEnhancer-COoIe53T.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-DJpwFbIy.js");
        import("./ExpressCheckoutContainerEnhancer-CGcESZC3.js");
        import("./OrderDisplayEnhancer-DhHXiopR.js");
        import("./index-DRgVu42F.js");
        import("./utils-CJHo6zrd.js").then((n) => n.G);
        import("./index-C4G5cayo.js");
        import("./index-BiuYmVkt.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-BAmFKpw3.js");
        import("./CouponEnhancer-BgE2t_6N.js");
        import("./SimpleExitIntentEnhancer-BWSARiGp.js");
