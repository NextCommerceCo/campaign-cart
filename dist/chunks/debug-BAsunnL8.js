import { c as createLogger, L as Logger, d as CountryService, E as EventBus } from "./utils-6135MyCb.js";
...
class LocaleSelector {
  ...
  async handleLocaleChange(newLocale, isReset = false) {
    ...
    try {
      ...
      const { CurrencyFormatter } = await import("./utils-6135MyCb.js").then((n) => n.y);
