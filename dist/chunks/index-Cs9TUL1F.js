import { a as useCartStore, u as useCampaignStore, d as useAttributionStore, b as useCheckoutStore, c as configStore } from "./analytics-hnrlm383.js";
import { u as useOrderStore, t as testModeManager } from "./debug-Bv1t1Tsh.js";
import { L as Logger, E as EventBus, u as useParameterStore, c as createLogger, b as CountryService, C as CART_STORAGE_KEY, d as LogLevel } from "./utils-COqAt8L9.js";
...
class NextCommerce {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-hnrlm383.js").then((n) => n.j);
  ...
  async trackViewItem(packageId) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-hnrlm383.js").then((n) => n.j);
        const { useCampaignStore: useCampaignStore2 } = await import("./analytics-hnrlm383.js").then((n) => n.f);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./analytics-hnrlm383.js").then((n) => n.j);
        nextAnalytics.track(
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-d3BI4ihd.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-E_lgIU_N.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart" || parsed.object === "cart-summary") {
            ...
            const { CartDisplayEnhancer } = await import("./index-DKYdL4sc.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-BUElRbZw.js");
            ...
            const { PackageSelectorDisplayEnhancer } = await import("./index-gC3_Popo.js");
            ...
            const { PackageToggleDisplayEnhancer } = await import("./index-Cp6bWkS4.js");
        ...
        case "package-toggle":
          const { PackageToggleEnhancer } = await import("./index-Cp6bWkS4.js");
          return new PackageToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./index-DER7AyK0.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./index-DCnChV_f.js");
        ...
        case "package-selector":
          const { PackageSelectorEnhancer } = await import("./index-gC3_Popo.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-Can-LNbG.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-C9B5e_ZU.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-tFk0pK_h.js");
        ...
        case "checkout-review":
          ...
          const { CheckoutReviewEnhancer } = await import("./CheckoutReviewEnhancer-hBf7GO6M.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-BL2p3KaL.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./index-BNUVLGm6.js");
          return new CartItemListEnhancer(element);
        case "cart-summary":
          const { CartSummaryEnhancer } = await import("./index-DKYdL4sc.js");
          return new CartSummaryEnhancer(element);
        case "bundle-selector":
          const { BundleSelectorEnhancer } = await import("./index-DJ7uxIqX.js");
          return new BundleSelectorEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-D8mjFpcC.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./index-BZq9TOCh.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./index-BRG0OqMw.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./index-Dx8RdKrw.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-BaZSnknI.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-3eMhCVyd.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-D21G1wKF.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-CPP5tl29.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-BR3ozMs-.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async captureUrlParameters(urlParams) {
    try {
      const { useParameterStore: useParameterStore2 } = await import("./utils-COqAt8L9.js").then((n) => n.H);
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-COqAt8L9.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-COqAt8L9.js").then((n) => n.M).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./debug-Bv1t1Tsh.js").then((n) => n.D);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./debug-Bv1t1Tsh.js").then((n) => n.D).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./index-DKYdL4sc.js");
        import("./index-Cp6bWkS4.js");
        import("./index-gC3_Popo.js");
        import("./ProductDisplayEnhancer-B_grPgaG.js");
        import("./SelectionDisplayEnhancer-BUElRbZw.js");
        import("./TimerEnhancer-Can-LNbG.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-tFk0pK_h.js");
        import("./ExpressCheckoutContainerEnhancer-BL2p3KaL.js");
        import("./OrderDisplayEnhancer-x3zxiey4.js");
        import("./index-Dx8RdKrw.js");
        import("./utils-COqAt8L9.js").then((n) => n.J);
        import("./index-BNUVLGm6.js");
        import("./index-BZq9TOCh.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-3eMhCVyd.js");
        import("./CouponEnhancer-BaZSnknI.js");
        import("./SimpleExitIntentEnhancer-d3BI4ihd.js");
      }, { timeout: 5e3 });
    } else {
      setTimeout(() => {
        import("./index-DKYdL4sc.js");
        import("./ProductDisplayEnhancer-B_grPgaG.js");
        import("./utils-COqAt8L9.js").then((n) => n.N);
      }, 1e3);
    }
  });
}
