import { c as createLogger, L as Logger, b as CountryService, E as EventBus, f as formatCurrency } from "./utils-C50dL0y-.js";
import { c as configStore, u as useCampaignStore, a as useCartStore, b as useCheckoutStore } from "./analytics-38ZOc1ko.js";
...
class LocaleSelector {
  ...
  async handleLocaleChange(newLocale, isReset = false) {
    ...
    try {
      ...
      const { CurrencyFormatter } = await import("./utils-C50dL0y-.js").then((n) => n.B);
      CurrencyFormatter.clearCache();
      const { useCartStore: useCartStore2 } = await import("./analytics-38ZOc1ko.js").then((n) => n.i);
