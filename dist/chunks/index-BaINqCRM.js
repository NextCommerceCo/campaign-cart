import { a as useCartStore, u as useCampaignStore, e as useAttributionStore, b as useCheckoutStore, c as configStore, d as useProfileStore } from "./analytics-C_Fzo5bG.js";
import { u as useOrderStore, t as testModeManager } from "./debug-CQ9mQdlO.js";
import { L as Logger, E as EventBus, u as useParameterStore, c as createLogger, d as CountryService, a as CART_STORAGE_KEY, e as LogLevel } from "./utils-C0UWTkxd.js";
import { ApiClient } from "./api-B_qiUCfx.js";
class NextCommerce {
  constructor() {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-C_Fzo5bG.js").then((n) => n.i);
  ...
  async trackViewItem(packageId) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-C_Fzo5bG.js").then((n) => n.i);
        const { useCampaignStore: useCampaignStore2 } = await import("./analytics-C_Fzo5bG.js").then((n) => n.g);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./analytics-C_Fzo5bG.js").then((n) => n.i);
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-WHPZlxqI.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-l8gPws83.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-zJlzM3MK.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-ouPaMIIa.js");
        ...
        case "toggle":
          const { CartToggleEnhancer } = await import("./CartToggleEnhancer-KI117-dy.js");
          return new CartToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./AddToCartEnhancer-BygSNWQ1.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-BHKRbM8r.js");
        ...
        case "selector":
          const { PackageSelectorEnhancer } = await import("./PackageSelectorEnhancer-Bh2gis2j.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-DgOwyP-8.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-C65fAkP-.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-C34Mf89U.js");
        ...
        case "checkout-review":
          ...
          const { CheckoutReviewEnhancer } = await import("./CheckoutReviewEnhancer-Bs3oP7sT.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-DuH1OT7C.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-D6Q8Fn_B.js");
          return new CartItemListEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-Dz1-aXlw.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./QuantityControlEnhancer-C80JgzQ4.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./RemoveItemEnhancer-Co5wwCmx.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-BKqAnZ1A.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-4zTKjKZw.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-DfffUJgk.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-CD1TBRtS.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-BIR6bqyU.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-UwiZc1rL.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async captureUrlParameters(urlParams) {
    try {
      const { useParameterStore: useParameterStore2 } = await import("./utils-C0UWTkxd.js").then((n) => n.A);
  ...
  static async processProfileParameter() {
    ...
    if (configStore$1.profiles && Object.keys(configStore$1.profiles).length > 0) {
      const { useProfileStore: useProfileStore22 } = await import("./analytics-C_Fzo5bG.js").then((n) => n.p);
    ...
    const { useProfileStore: useProfileStore2 } = await import("./analytics-C_Fzo5bG.js").then((n) => n.p);
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-C0UWTkxd.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-C0UWTkxd.js").then((n) => n.G).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./debug-CQ9mQdlO.js").then((n) => n.D);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./debug-CQ9mQdlO.js").then((n) => n.D).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-zJlzM3MK.js");
        import("./CartToggleEnhancer-KI117-dy.js");
        import("./PackageSelectorEnhancer-Bh2gis2j.js");
        import("./ProductDisplayEnhancer-DnDLaLLT.js");
        import("./SelectionDisplayEnhancer-ouPaMIIa.js");
        import("./TimerEnhancer-DgOwyP-8.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-C34Mf89U.js");
        import("./ExpressCheckoutContainerEnhancer-DuH1OT7C.js");
        import("./OrderDisplayEnhancer-BqgHCnGx.js");
        import("./UpsellEnhancer-BKqAnZ1A.js");
        import("./utils-C0UWTkxd.js").then((n) => n.B);
        import("./CartItemListEnhancer-D6Q8Fn_B.js");
        import("./QuantityControlEnhancer-C80JgzQ4.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-DfffUJgk.js");
        import("./CouponEnhancer-4zTKjKZw.js");
        import("./SimpleExitIntentEnhancer-WHPZlxqI.js");
      ...
      setTimeout(() => {
        import("./CartDisplayEnhancer-zJlzM3MK.js");
        import("./ProductDisplayEnhancer-DnDLaLLT.js");
        import("./utils-C0UWTkxd.js").then((n) => n.H);
      }, 1e3);
    }
  });
}
