import { c as createLogger, L as Logger, a as configStore, u as useCampaignStore, C as CountryService, E as EventBus } from "./utils-BuscMPQd.js";
...
class LocaleSelector {
  ...
  async handleLocaleChange(newLocale, isReset = false) {
    ...
    try {
      ...
      const { CurrencyFormatter } = await import("./utils-BuscMPQd.js").then((n) => n.I);
      CurrencyFormatter.clearCache();
      const { useCartStore: useCartStore2 } = await import("./analytics-BQliK5x8.js").then((n) => n.d);
