      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart" || parsed.object === "cart-summary") {
            ...
            const { CartDisplayEnhancer } = await import("./index-BIQstqpI.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-DuftM5Ij.js");
            ...
            const { PackageSelectorDisplayEnhancer } = await import("./index-CnztT550.js");
            ...
            const { PackageToggleDisplayEnhancer } = await import("./index-B84TYGyr.js");
        ...
        case "package-toggle":
          const { PackageToggleEnhancer } = await import("./index-B84TYGyr.js");
          return new PackageToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./index-Dcssx-zB.js");
        ...
        case "package-selector":
          const { PackageSelectorEnhancer } = await import("./index-CnztT550.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-CoukAlZV.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./index-CdYheNwe.js");
          return new CartItemListEnhancer(element);
        case "cart-summary":
          const { CartSummaryEnhancer } = await import("./index-BIQstqpI.js");
          return new CartSummaryEnhancer(element);
        case "bundle-selector":
          const { BundleSelectorEnhancer } = await import("./index-CIjHPY_X.js");
          return new BundleSelectorEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-DiRdCD71.js");
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./index-BIQstqpI.js");
        import("./index-B84TYGyr.js");
        import("./index-CnztT550.js");
        import("./ProductDisplayEnhancer-B_Ogb98T.js");
        import("./SelectionDisplayEnhancer-DuftM5Ij.js");
      ...
      requestIdleCallback(() => {
        ...
        import("./OrderDisplayEnhancer-CllTL2VM.js");
        import("./index-Dx8RdKrw.js");
        import("./utils-COqAt8L9.js").then((n) => n.J);
        import("./index-CdYheNwe.js");
