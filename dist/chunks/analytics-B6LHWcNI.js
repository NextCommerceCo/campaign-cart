import { c as create, p as persist, s as subscribeWithSelector } from "./vendor-Bn6IlrKj.js";
<<<<<<<< HEAD:dist/chunks/analytics-BuAKAb38.js
import { c as createLogger, b as CART_STORAGE_KEY, s as sessionStorageManager, d as formatPercentage, f as formatCurrency, E as EventBus, a as configStore, u as useCampaignStore } from "./utils-CQa_9vcu.js";
========
import { c as createLogger, b as CART_STORAGE_KEY, s as sessionStorageManager, f as formatPercentage, d as formatCurrency, E as EventBus, a as configStore, u as useCampaignStore } from "./utils-DvNc5oJP.js";
>>>>>>>> 7e5c29115709fb63d927fddd1b927f667966c0ea:dist/chunks/analytics-B6LHWcNI.js
...
<<<<<<<< HEAD:dist/chunks/analytics-BuAKAb38.js
        ...
        const { useProfileStore } = await import("./utils-CQa_9vcu.js").then((n) => n.H);
========
        const { useCampaignStore: useCampaignStore2 } = await import("./utils-DvNc5oJP.js").then((n) => n.B);
        const { useProfileStore } = await import("./utils-DvNc5oJP.js").then((n) => n.G);
>>>>>>>> 7e5c29115709fb63d927fddd1b927f667966c0ea:dist/chunks/analytics-B6LHWcNI.js
        ...
        if (!packageData) {
          throw new Error(
            `Package ${finalPackageId} not found in campaign data`
          );
        }
        set((state) => {
          const newItem = {
...
>>>>>>>> 7e5c29115709fb63d927fddd1b927f667966c0ea:dist/chunks/analytics-B6LHWcNI.js
        ...
        if (profileStore.activeProfileId) {
          ...
          if (mappedRemoveId !== removePackageId) {
            logger$9.debug(
              `Applying profile mapping to remove package: ${removePackageId} -> ${mappedRemoveId}`
            );
...
========
            ...
            logger$9.debug("Available packages:", campaignStore.data?.packages?.map((p) => p.ref_id));
>>>>>>>> 7e5c29115709fb63d927fddd1b927f667966c0ea:dist/chunks/analytics-B6LHWcNI.js
            continue;
          }
...
<<<<<<<< HEAD:dist/chunks/analytics-BuAKAb38.js
          ...
          const { calculateCart } = await import("./utils-CQa_9vcu.js").then((n) => n.K);
========
          const { useCampaignStore: useCampaignStore2 } = await import("./utils-DvNc5oJP.js").then((n) => n.B);
>>>>>>>> 7e5c29115709fb63d927fddd1b927f667966c0ea:dist/chunks/analytics-B6LHWcNI.js
          ...
          try {
            ...
            const enrichedTotals = (() => {
              ...
              const savingsPct = retailCompareTotal > 0 ? retailSavings / retailCompareTotal * 100 : 0;
              const totalSavingsPct = retailCompareTotal > 0 ? totalSavingsValue / retailCompareTotal * 100 : 0;
              return {
                ...totals,
                compareTotal: {
            ...
            logger$9.error("Failed to sync cart with API:", error);
          }
        } catch (error) {
...
>>>>>>>> 7e5c29115709fb63d927fddd1b927f667966c0ea:dist/chunks/analytics-B6LHWcNI.js
          ...
          const enrichedItems = state.items.map((item) => {
            ...
            const retailUnitPrice = parseFloat(
              packageData?.price_retail || packageData?.price || "0"
            );
            ...
            return {
              ...
              price: {
                excl_tax: {
                  ...
                  formatted: formatCurrency(actualUnitPrice)
                },
                incl_tax: {
                  value: actualUnitPrice,
                  formatted: formatCurrency(actualUnitPrice)
                ...
                original: {
                  ...
                  formatted: formatCurrency(retailUnitPrice)
                },
                savings: {
                  value: unitSavings,
                  formatted: formatCurrency(unitSavings)
                },
                recurring: {
                  value: recurringPrice,
                  formatted: formatCurrency(recurringPrice)
                },
                // Line totals
                lineTotal: {
                  value: lineTotal,
                  formatted: formatCurrency(lineTotal)
                },
                lineCompare: {
                  value: retailLineTotal,
                  formatted: formatCurrency(retailLineTotal)
                },
                lineSavings: {
                  value: lineSavings,
                  formatted: formatCurrency(lineSavings)
                },
                // Calculated fields
                savingsPct: {
                  value: savingsPct,
...
<<<<<<<< HEAD:dist/chunks/analytics-BuAKAb38.js
        ...
        const checkoutState = useCheckoutStore2.getState();
========
        const { useConfigStore } = await import("./utils-DvNc5oJP.js").then((n) => n.H);
...
>>>>>>>> 7e5c29115709fb63d927fddd1b927f667966c0ea:dist/chunks/analytics-B6LHWcNI.js
          ...
          const updatedItems = state.items.map((item) => {
            ...
            if (!packageData) {
              logger$9.warn(
                `Package ${item.packageId} not found in campaign data`
              );
              return item;
            }
            return {
...
========
              logger$9.info(`Updated shipping method price: ${updatedShippingMethod.code} = ${newPrice} ${campaignStore.data.currency}`);
>>>>>>>> 7e5c29115709fb63d927fddd1b927f667966c0ea:dist/chunks/analytics-B6LHWcNI.js
            }
          }
          set((state2) => {
          ...
          logger$9.info(
            "Cart item prices and shipping refreshed with new currency"
          );
          setTimeout(() => {
            get().calculateTotals();
          }, 0);
  ...
  persist(
    (set, get) => ({
      ...
      initialize: async () => {
        try {
<<<<<<<< HEAD:dist/chunks/analytics-BuAKAb38.js
          const { AttributionCollector } = await import("./utils-CQa_9vcu.js").then((n) => n.M);
========
          const { AttributionCollector } = await import("./utils-DvNc5oJP.js").then((n) => n.K);
>>>>>>>> 7e5c29115709fb63d927fddd1b927f667966c0ea:dist/chunks/analytics-B6LHWcNI.js
...
class EcommerceEvents {
  ...
  static createAcceptedUpsellEvent(data) {
    ...
    try {
      if (typeof window !== "undefined") {
        campaignStore = window.campaignStore;
        if (campaignStore) {
          const campaign = campaignStore.getState().data;
...
export {
  ...
  useCheckoutStore as a,
  useAttributionStore as b,
  userDataStorage as c,
  cartStore as d,
<<<<<<<< HEAD:dist/chunks/analytics-BuAKAb38.js
  checkoutStore as e,
========
