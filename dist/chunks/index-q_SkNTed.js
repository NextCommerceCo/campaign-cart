import { a as useCartStore, u as useCampaignStore, d as useAttributionStore, c as configStore, b as useProfileStore } from "./analytics-CkSoSSCD.js";
import { u as useCheckoutStore, a as useOrderStore, t as testModeManager } from "./debug-UN6FtqbN.js";
import { c as create, p as persist } from "./vendor-DmEBrpID.js";
import { c as createLogger, L as Logger, E as EventBus, d as CountryService, a as CART_STORAGE_KEY, e as LogLevel } from "./utils-Be4BSRfm.js";
...
class NextCommerce {
  ...
  async trackViewItemList(packageIds, _listId, listName) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics } = await import("./analytics-CkSoSSCD.js").then((n) => n.i);
  ...
  async trackRemoveFromCart(packageId, quantity) {
    queueMicrotask(async () => {
      try {
        const { nextAnalytics, EcommerceEvents } = await import("./analytics-CkSoSSCD.js").then((n) => n.i);
  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-DWJxaF9D.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-BE-5AzeK.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-DnP13omg.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-DPjMH4Q5.js");
        ...
        case "toggle":
          const { CartToggleEnhancer } = await import("./CartToggleEnhancer-BtQhkSgU.js");
          return new CartToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./AddToCartEnhancer-3XN-G5Ej.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-CdwxVMGI.js");
        ...
        case "selector":
          const { PackageSelectorEnhancer } = await import("./PackageSelectorEnhancer-C1RrtNbq.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-BZgoFN44.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-DAQlB2Q8.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-DAOUd8Bg.js");
        ...
        case "checkout-review":
          ...
          const { CheckoutReviewEnhancer } = await import("./CheckoutReviewEnhancer-BHblCLiD.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-Lj2OF714.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-bSxWgn26.js");
          return new CartItemListEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-Cutcx00q.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./QuantityControlEnhancer-B600CJyp.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./RemoveItemEnhancer-CaFpMhMB.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-CS3MeEAU.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-BgZj8AMs.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-Rii2BGIG.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-C1W8fJi8.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-BAbCotpj.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-hpMi4HWS.js");
...
const _SDKInitializer = class _SDKInitializer {
  ...
  static async processProfileParameter() {
    ...
    if (configStore$1.profiles && Object.keys(configStore$1.profiles).length > 0) {
      const { useProfileStore: useProfileStore22 } = await import("./analytics-CkSoSSCD.js").then((n) => n.p);
    ...
    const { useProfileStore: useProfileStore2 } = await import("./analytics-CkSoSSCD.js").then((n) => n.p);
  ...
  static async initializeAttribution() {
    try {
      ...
      if (configStore$1.utmTransfer?.enabled) {
        const { UtmTransfer } = await import("./utils-Be4BSRfm.js").then((n) => n.U);
  ...
  static initializeErrorHandler() {
    try {
      import("./utils-Be4BSRfm.js").then((n) => n.z).then(({ errorHandler }) => {
  ...
  static async initializeDebugMode() {
    ...
    if (configStore$1.debug) {
      ...
      const { debugOverlay } = await import("./debug-UN6FtqbN.js").then((n) => n.D);
  ...
  static setupGlobalDebugUtils() {
    if (typeof window !== "undefined") {
      window.nextDebug = {
        overlay: () => import("./debug-UN6FtqbN.js").then((n) => n.D).then((m) => m.debugOverlay),
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-DnP13omg.js");
        import("./CartToggleEnhancer-BtQhkSgU.js");
        import("./PackageSelectorEnhancer-C1RrtNbq.js");
        import("./ProductDisplayEnhancer-QEdZQiPs.js");
        import("./SelectionDisplayEnhancer-DPjMH4Q5.js");
        import("./TimerEnhancer-BZgoFN44.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-DAOUd8Bg.js");
        import("./ExpressCheckoutContainerEnhancer-Lj2OF714.js");
        import("./OrderDisplayEnhancer-DV-qlI9l.js");
        import("./UpsellEnhancer-CS3MeEAU.js");
        import("./utils-Be4BSRfm.js").then((n) => n.A);
        import("./CartItemListEnhancer-bSxWgn26.js");
        import("./QuantityControlEnhancer-B600CJyp.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-Rii2BGIG.js");
        import("./CouponEnhancer-BgZj8AMs.js");
        import("./SimpleExitIntentEnhancer-DWJxaF9D.js");
      ...
      setTimeout(() => {
        import("./CartDisplayEnhancer-DnP13omg.js");
        import("./ProductDisplayEnhancer-QEdZQiPs.js");
        import("./utils-Be4BSRfm.js").then((n) => n.B);
      }, 1e3);
    }
  });
}
