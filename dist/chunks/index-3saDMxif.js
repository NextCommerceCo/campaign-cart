  ...
  async exitIntent(options) {
    try {
      if (!this.exitIntentEnhancer) {
        const { ExitIntentEnhancer } = await import("./SimpleExitIntentEnhancer-D4qFfz_Q.js");
  ...
  async fomo(config) {
    try {
      if (!this.fomoEnhancer) {
        const { FomoPopupEnhancer } = await import("./FomoPopupEnhancer-DJDlsjSc.js");
      ...
      switch (type) {
        case "display":
          ...
          if (parsed.object === "cart") {
            ...
            const { CartDisplayEnhancer } = await import("./CartDisplayEnhancer-C9Tjavtd.js");
            return new CartDisplayEnhancer(element);
          } else if (parsed.object === "selection") {
            this.logger.debug("Using SelectionDisplayEnhancer");
            const { SelectionDisplayEnhancer } = await import("./SelectionDisplayEnhancer-Cj9typoI.js");
        ...
        case "package-toggle":
          const { PackageToggleEnhancer } = await import("./PackageToggleEnhancer-BjsWl4Xl.js");
          return new PackageToggleEnhancer(element);
        case "action":
          const action = element.getAttribute("data-next-action");
          switch (action) {
            case "add-to-cart":
              const { AddToCartEnhancer } = await import("./AddToCartEnhancer-D3MlxABn.js");
              return new AddToCartEnhancer(element);
            case "accept-upsell":
              const { AcceptUpsellEnhancer } = await import("./AcceptUpsellEnhancer-D4qvlLMs.js");
        ...
        case "package-selector":
          const { PackageSelectorEnhancer } = await import("./PackageSelectorEnhancer-Bzxs_BxS.js");
          return new PackageSelectorEnhancer(element);
        case "timer":
          const { TimerEnhancer } = await import("./TimerEnhancer-le_9b-AP.js");
        ...
        case "conditional":
          ...
          const { ConditionalDisplayEnhancer } = await import("./ConditionalDisplayEnhancer-Bl0pKwrZ.js");
          return new ConditionalDisplayEnhancer(element);
        case "checkout":
          const { CheckoutFormEnhancer } = await import("./CheckoutFormEnhancer-Q-xhk6LG.js");
        ...
        case "checkout-review":
          ...
          const { CheckoutReviewEnhancer } = await import("./CheckoutReviewEnhancer-Jkob8g8f.js");
        ...
        case "express-checkout-container":
          const { ExpressCheckoutContainerEnhancer } = await import("./ExpressCheckoutContainerEnhancer-DBw9TcaN.js");
        ...
        case "cart-items":
          const { CartItemListEnhancer } = await import("./CartItemListEnhancer-B6aeozZw.js");
          return new CartItemListEnhancer(element);
        case "cart-summary":
          const { CartSummaryEnhancer } = await import("./CartSummaryEnhancer-B_L0AesY.js");
          return new CartSummaryEnhancer(element);
        case "bundle-selector":
          const { BundleSelectorEnhancer } = await import("./BundleSelectorEnhancer-HOe1TPMj.js");
          return new BundleSelectorEnhancer(element);
        case "order-items":
          const { OrderItemListEnhancer } = await import("./OrderItemListEnhancer-7gIFVByE.js");
          return new OrderItemListEnhancer(element);
        case "quantity":
          const { QuantityControlEnhancer } = await import("./QuantityControlEnhancer-BPYIvLCf.js");
          return new QuantityControlEnhancer(element);
        case "remove-item":
          const { RemoveItemEnhancer } = await import("./RemoveItemEnhancer-DFe8gQEj.js");
        ...
        case "upsell":
          const { UpsellEnhancer } = await import("./UpsellEnhancer-5jf3eMER.js");
          return new UpsellEnhancer(element);
        case "coupon":
          const { CouponEnhancer } = await import("./CouponEnhancer-DUTo-GQU.js");
          return new CouponEnhancer(element);
        case "accordion":
          const { AccordionEnhancer } = await import("./AccordionEnhancer-CzFDh9Z8.js");
          return new AccordionEnhancer(element);
        case "tooltip":
          const { TooltipEnhancer } = await import("./TooltipEnhancer-BcJEZ6yb.js");
          return new TooltipEnhancer(element);
        case "scroll-hint":
          const { ScrollHintEnhancer } = await import("./ScrollHintEnhancer-CbD1FU0U.js");
          return new ScrollHintEnhancer(element);
        case "quantity-text":
          const { QuantityTextEnhancer } = await import("./QuantityTextEnhancer-BPcJ0mlK.js");
...
if (typeof window !== "undefined") {
  ...
  window.addEventListener("next:ready", () => {
    if ("requestIdleCallback" in window) {
      requestIdleCallback(() => {
        import("./CartDisplayEnhancer-C9Tjavtd.js");
        import("./PackageToggleEnhancer-BjsWl4Xl.js");
        import("./PackageSelectorEnhancer-Bzxs_BxS.js");
        import("./ProductDisplayEnhancer-DsqHGIJL.js");
        import("./SelectionDisplayEnhancer-Cj9typoI.js");
        import("./TimerEnhancer-le_9b-AP.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./CheckoutFormEnhancer-Q-xhk6LG.js");
        import("./ExpressCheckoutContainerEnhancer-DBw9TcaN.js");
        import("./OrderDisplayEnhancer-DlO2ItrQ.js");
        import("./UpsellEnhancer-5jf3eMER.js");
        import("./utils-B70_3MK6.js").then((n) => n.M);
        import("./CartItemListEnhancer-B6aeozZw.js");
        import("./QuantityControlEnhancer-BPYIvLCf.js");
      }, { timeout: 5e3 });
      requestIdleCallback(() => {
        import("./AccordionEnhancer-CzFDh9Z8.js");
        import("./CouponEnhancer-DUTo-GQU.js");
        import("./SimpleExitIntentEnhancer-D4qFfz_Q.js");
