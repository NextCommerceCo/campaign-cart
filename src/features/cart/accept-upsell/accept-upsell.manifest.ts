...
export default defineFeature({
  ...
  attributes: [
    ...
    },
    {
      ...
      notes:
        'The selector must carry `data-next-upsell-context`, or it will write to the cart instead of leaving the choice to this button. A selector in upsell context pre-selects a card while booting, and this button reads that pre-selection when it initialises, so it arms itself without waiting for a click. A selector container that renders more than 100ms after the button is the exception — then the button starts disabled and arms on the first card click.',
    },
    {
