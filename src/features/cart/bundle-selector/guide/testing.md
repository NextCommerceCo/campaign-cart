---
title: "Features/Cart/Bundle Selector/Testing"
group: "Features"
...
> Test file: `src/features/cart/bundle-selector/tests/applyBundle.test.ts`
...
- `applyBundle` reads `cartStore.items` and calls `cartOperations.swapCart` — it does not
