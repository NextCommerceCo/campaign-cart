---
title: "Features/Display/Order Display/Logs"
group: "Features"
...
Every message `order-display` can print, under the logger prefix `OrderDisplayEnhancer`. Search a console line here to find what produced it.
