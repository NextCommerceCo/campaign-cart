---
title: "Features/Display/Timer/Logs"
group: "Features"
category: "Timer"
---
...
Every message `timer` can print, under the logger prefix `TimerEnhancer`. Search a console line here to find what produced it.
...
|---|---|---|
| `Initialized timer: {duration}s, persistence: {persistenceId}` | `timer.enhancer.ts › TimerEnhancer.initialize` | — |
| `Timer expired: {persistenceId}` | `timer.enhancer.ts › TimerEnhancer.handleTimerExpired` | — |
