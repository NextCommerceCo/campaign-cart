---
title: "Features/UI/Scroll Hint/Logs"
group: "Features"
...
Every message `scroll-hint` can print, under the logger prefix `ScrollHintEnhancer`. Search a console line here to find what produced it.
