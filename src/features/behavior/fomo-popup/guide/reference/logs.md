---
title: "Features/Behavior/FOMO Popup/Logs"
group: "Features"
category: "FOMO Popup"
---
...
Every message `fomo-popup` can print, under the logger prefix `FomoPopupEnhancer`. Search a console line here to find what produced it.
