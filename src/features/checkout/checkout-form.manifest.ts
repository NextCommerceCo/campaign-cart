...
export default defineFeature({
  ...
  // The form delegates to the shared checkout helpers; its attribute contract is
  // spread across them rather than living in one file.
  extraSource: ['services', 'managers', 'processors', 'validation'],
