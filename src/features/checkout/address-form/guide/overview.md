...
- `data-next-address="billing"` is accepted and warns: the checkout form builds its
  billing address by copying the shipping one.
...
- Does not build the billing address. The checkout form copies the shipping one.
