      ...
      switch (type) {
        case 'display':
          ...
          if (parsed.object === 'cart' || parsed.object === 'cart-summary') {
            ...
            const { CartDisplayEnhancer } = await import('@/features/cart/cart-summary');
            ...
            const { BundleDisplayEnhancer } = await import('@/features/cart/bundle-selector');
            ...
            const { PackageSelectorDisplayEnhancer } = await import('@/features/cart/package-selector');
            ...
            const { PackageToggleDisplayEnhancer } = await import('@/features/cart/package-toggle');
        ...
        case 'package-toggle':
          const { PackageToggleEnhancer } = await import('@/features/cart/package-toggle');
        ...
        case 'action':
          ...
          switch (action) {
            case 'add-to-cart':
              const { AddToCartEnhancer } = await import('@/features/cart/add-to-cart');
              return new AddToCartEnhancer(element);
              
            case 'accept-upsell':
              const { AcceptUpsellEnhancer } = await import('@/features/cart/accept-upsell');
        ...
        case 'package-selector':
          const { PackageSelectorEnhancer } = await import('@/features/cart/package-selector');
        ...
        case 'cart-items':
          const { CartItemListEnhancer } = await import('@/features/cart/cart-item-list');
          return new CartItemListEnhancer(element);

        case 'cart-summary':
          const { CartSummaryEnhancer } = await import('@/features/cart/cart-summary');
          return new CartSummaryEnhancer(element);

        case 'bundle-selector':
          const { BundleSelectorEnhancer } = await import('@/features/cart/bundle-selector');
        ...
        case 'quantity':
          const { QuantityControlEnhancer } = await import('@/features/cart/quantity-control');
          return new QuantityControlEnhancer(element);

        case 'remove-item':
          const { RemoveItemEnhancer } = await import('@/features/cart/remove-item');
        ...
        case 'upsell':
          const { UpsellEnhancer } = await import('@/features/order/upsell');
